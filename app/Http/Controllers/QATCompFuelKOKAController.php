...
class QATCompFuelKOKAController extends Controller
{
    public function index(){
        $tubes = TubeCompFuelKOKA::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tCompfuelKOKA.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tCompfuelKOKA.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tCompfuelKOKA');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tCompfuelKOKA.edit')->with(compact('tube'));
