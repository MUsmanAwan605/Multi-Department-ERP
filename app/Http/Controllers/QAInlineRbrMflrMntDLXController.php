...
class QAInlineRbrMflrMntDLXController extends Controller
{
    public function index(){
        $tubes = InlineRbrMflrMntDLX::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.RbrMflrMntDLX.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.RbrMflrMntDLX.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/RbrMflrMntDLX');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.RbrMflrMntDLX.edit')->with(compact('tube'));
