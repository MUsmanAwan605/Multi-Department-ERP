...
class AdminQAInlineTABreatherCG125Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeABreatherCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.taBreatherCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.taBreatherCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/taBreather-CG125');
    ...
    public function edit(string $id){
        ...
        return view('admin.inline.taBreatherCG125.edit')->with(compact('tube'));
