...
class AdminQAInlineTBtryBreatherKOKAController extends Controller
{
    public function index(){
        $tubes = InlineTubeBtryBreatherKOKA::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tBatteryBreatherKOKA.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tBatteryBreatherKOKA.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/tBtryBreatherKOKA');
    ...
    public function edit(string $id){
        ...
        return view('admin.inline.tBatteryBreatherKOKA.edit')->with(compact('tube'));
