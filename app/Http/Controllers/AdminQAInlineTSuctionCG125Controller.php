...
class AdminQAInlineTSuctionCG125Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeSuctionCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tSuctionCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tSuctionCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/tSuctionCG125');

    }

    public function edit(string $id){

        $tube = InlineTubeSuctionCG125::find($id);
        return view('admin.inline.tSuctionCG125.edit')->with(compact('tube'));
