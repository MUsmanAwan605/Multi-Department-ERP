...
class QAInlineTBtryBreatherCG125Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeBtryBreatherCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tBatteryBreatherCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tBatteryBreatherCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tBtryBreatherCG125');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tBatteryBreatherCG125.edit')->with(compact('tube'));
