...
class QAInlineTBtryBreatherDLXController extends Controller
{
    public function index(){
        $tubes = InlineTubeBtryBreatherDLX::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tBatteryBreatherDLX.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tBatteryBreatherDLX.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tBtryBreatherDLX');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tBatteryBreatherDLX.edit')->with(compact('tube'));
