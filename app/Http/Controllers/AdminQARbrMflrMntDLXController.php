...
class AdminQARbrMflrMntDLXController extends Controller
{
    public function index(){
        $tubes = RbrMflrMntDLX::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.RbrMflrMntDLX.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.RbrMflrMntDLX.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/RbrMflrMntDLX');
    ...
    public function edit(string $id){
        ...
        return view('admin.final.RbrMflrMntDLX.edit')->with(compact('tube'));
