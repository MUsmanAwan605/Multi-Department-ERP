...
class QATBtryBreatherDLXController extends Controller
{
    public function index(){
        $tubes = TubeBtryBreatherDLX::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tBatteryBreatherDLX.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tBatteryBreatherDLX.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tBtryBreatherDLX');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tBatteryBreatherDLX.edit')->with(compact('tube'));
