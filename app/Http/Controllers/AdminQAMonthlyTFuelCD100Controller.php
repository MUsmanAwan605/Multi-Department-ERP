...
class AdminQAMonthlyTFuelCD100Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.monthly.tfuelCD100.index')->with(compact('tubes'));
    ...
    {
        return view('admin.monthly.tfuelCD100.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('admin/monthly/tfuelCD-100');
    }
    ...
    public function view(Request $request){
        ...
        return view('admin.monthly.tfuelCD100.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.monthly.tfuelCD100.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('admin.monthly.tfuelCD100.view',compact('records','data'));
    }
}
