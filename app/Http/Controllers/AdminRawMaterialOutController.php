...
class AdminRawMaterialOutController extends Controller
{
    /**
     ...
     */
     ...
     public function index()
     {
         ...
         return view("admin.store.rawmateriallout.index")->with(compact('rawmaterials'));
     }
    ...
    public function create()
    {
        ...
        return view('admin.store.rawmateriallout.add', compact('rawmaterials'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to(route('adminraw-materialout.index'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view("admin.store.rawmaterialout.edit")->with(compact('rawmaterial'));
    }
    ...
    public function search(Request $request){
        ...
        return view('admin.store.rawmateriallout.view', compact('searchQuery', 'records'));
    }
