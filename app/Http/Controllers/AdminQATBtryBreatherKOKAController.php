...
class AdminQATBtryBreatherKOKAController extends Controller
{
    public function index(){
        $tubes = TubeBtryBreatherKOKA::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.tBatteryBreatherKOKA.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.tBatteryBreatherKOKA.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/tBtryBreatherKOKA');

    }

    public function edit(string $id){

        $tube = TubeBtryBreatherKOKA::find($id);
        return view('admin.final.tBatteryBreatherKOKA.edit')->with(compact('tube'));
