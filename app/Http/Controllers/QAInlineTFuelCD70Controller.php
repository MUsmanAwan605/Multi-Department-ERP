...
class QAInlineTFuelCD70Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeFuelCD70::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tfuelCD70.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tfuelCD70.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tfuelCD-70');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tfuelCD70.edit')->with(compact('tube'));
