...
class AdminQAInlineTBtryBreatherCG125Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeBtryBreatherCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tBatteryBreatherCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tBatteryBreatherCG125.add');
    }
    public function store(Request $request){
        ...
        InlineTubeBtryBreatherCG125::create([
        ...
        return redirect()->to('/admin/inline/tBtryBreatherCG125');

    }

    public function edit(string $id){

        $tube = InlineTubeBtryBreatherCG125::find($id);
        return view('admin.inline.tBatteryBreatherCG125.edit')->with(compact('tube'));
