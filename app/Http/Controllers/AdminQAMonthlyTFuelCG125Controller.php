...
class AdminQAMonthlyTFuelCG125Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.monthly.tfuelCG125.index')->with(compact('tubes'));
    ...
    {
        return view('admin.monthly.tfuelCG125.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('admin/monthly/tfuelCG125');
    }
    ...
    public function search_data(Request $request){
        ...
        return view('admin.monthly.tfuelCG125.view',compact('records','data'));
    }
    ...
    //         $tubes = MonthlyTubeFuelCG125::all();
    //     }
    //     return view('admin.monthly.tfuelCG125.view')->with(compact('tubes','search'));
    // }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.monthly.tfuelCG125.edit')->with(compact('tube'));
    }
