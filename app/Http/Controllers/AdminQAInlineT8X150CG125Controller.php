...
class AdminQAInlineT8X150CG125Controller extends Controller
{
    public function index(){
        $tubes = InlineTube8X150CG125::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.t8X150CG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.t8X150CG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/t8X150CG125');

    }

    public function edit(string $id){

        $tube = InlineTube8X150CG125::find($id);
        return view('admin.inline.t8X150CG125.edit')->with(compact('tube'));
