...
class AdminQAInlineTSuctionKOKAController extends Controller
{
    public function index(){
        $tubes = InlineTubeSuctionKOKA::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tSuctionKOKA.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tSuctionKOKA.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/tSuctionKOKA');

    }

    public function edit(string $id){

        $tube = InlineTubeSuctionKOKA::find($id);
        return view('admin.inline.tSuctionKOKA.edit')->with(compact('tube'));
