...
class QAGrARearCvrCD100Controller extends Controller
{
    public function index(){
        $tubes = GrmtARearCvrCD100::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.GrmtARearCvrCD100.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.GrmtARearCvrCD100.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/GrmtARearCvrCD100');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.GrmtARearCvrCD100.edit')->with(compact('tube'));
