...
class AdminQATASVControlCG125Controller extends Controller
{
    public function index(){
        $tubes = TubeASVCntrlCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.tControlASVCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.tControlASVCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/tASV-CG125');
    ...
    public function edit(string $id){
        ...
        return view('admin.final.tControlASVCG125.edit')->with(compact('tube'));
