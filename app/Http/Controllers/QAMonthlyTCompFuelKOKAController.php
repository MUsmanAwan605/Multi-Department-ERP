...
class QAMonthlyTCompFuelKOKAController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('quality.monthly.tCompfuelKOKA.index')->with(compact('tubes'));
    ...
    {
        return view('quality.monthly.tCompfuelKOKA.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('qa/monthly/tCompfuelKOKA');
    }
    ...
    public function view(Request $request){
        ...
        return view('quality.monthly.tCompfuelKOKA.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('quality.monthly.tCompfuelKOKA.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('quality.monthly.tCompfuelKOKA.view',compact('records','data'));
    }
}
