...
class VendorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('store/vendor')->with('success', 'Vender Added successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->to('store/vendor')->with('success', 'Vender Update successfully.');
    }
    ...
    public function destroy(string $id)
    {
        $vendor = Vendor::find($id);
        $vendor->delete();
        return redirect()->to('store/vendor')->with('success', 'Vender Deleted successfully.');
    }
