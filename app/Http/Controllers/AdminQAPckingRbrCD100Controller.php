...
class AdminQAPckingRbrCD100Controller extends Controller
{
    public function index(){
        $tubes = PckngRbrCD100::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.PckngRbrCD100.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.PckngRbrCD100.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/PckngRbrCD100');
    ...
    public function edit(string $id){
        ...
        return view('admin.final.PckngRbrCD100.edit')->with(compact('tube'));
