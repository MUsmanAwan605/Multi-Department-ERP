...
class AdminQAInlineTBBreatherCD70Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeBBreatherCD70::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tbBreatherCD70.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tbBreatherCD70.add');
    }
    public function store(Request $request){
        ...
        InlineTubeBBreatherCD70::create([
        ...
        return redirect()->to('/admin/inline/tbBreather-CD70');

    }

    public function edit(string $id){

        $tube = InlineTubeBBreatherCD70::find($id);
        return view('admin.inline.tbBreatherCD70.edit')->with(compact('tube'));
