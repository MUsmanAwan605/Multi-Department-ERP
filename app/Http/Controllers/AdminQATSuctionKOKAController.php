...
class AdminQATSuctionKOKAController extends Controller
{
    public function index(){
        $tubes = TubeSuctionKOKA::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.tSuctionKOKA.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.tSuctionKOKA.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/tSuctionKOKA');

    }

    public function edit(string $id){

        $tube = TubeSuctionKOKA::find($id);
        return view('admin.final.tSuctionKOKA.edit')->with(compact('tube'));
