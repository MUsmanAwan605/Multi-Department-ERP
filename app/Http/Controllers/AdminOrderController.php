...
class AdminOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("admin.store.order.index")->with(compact('orders'));
    }
    ...
    {
        $order = Order::find($id);
        return view('/admin/production/order/edit')->with(compact('order'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('/admin/production/order/view',compact('records', 'date1', 'date2', 'title'));
    }
}
