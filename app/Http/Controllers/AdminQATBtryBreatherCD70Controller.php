...
class AdminQATBtryBreatherCD70Controller extends Controller
{
    public function index(){
        $tubes = TubeBtryBreatherCD70::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.tBatteryBreatherCD70.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.tBatteryBreatherCD70.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/tBtryBreatherCD70');

    }

    public function edit(string $id){

        $tube = TubeBtryBreatherCD70::find($id);
        return view('admin.final.tBatteryBreatherCD70.edit')->with(compact('tube'));
