...
class QATBtryBreatherKOKAController extends Controller
{
    public function index(){
        $tubes = TubeBtryBreatherKOKA::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tBatteryBreatherKOKA.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tBatteryBreatherKOKA.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tBtryBreatherKOKA');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tBatteryBreatherKOKA.edit')->with(compact('tube'));
