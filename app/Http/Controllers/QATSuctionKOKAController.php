...
class QATSuctionKOKAController extends Controller
{
    public function index(){
        $tubes = TubeSuctionKOKA::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tSuctionKOKA.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tSuctionKOKA.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tSuctionKOKA');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tSuctionKOKA.edit')->with(compact('tube'));
