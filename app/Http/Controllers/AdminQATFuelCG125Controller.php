...
class AdminQATFuelCG125Controller extends Controller
{
    public function index(){
        $tubes = TubeFuelCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.tfuelCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.tfuelCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/tfuelCG-125');

    }

    public function edit(string $id){

        $tube = TubeFuelCG125::find($id);
        return view('admin.final.tfuelCG125.edit')->with(compact('tube'));
