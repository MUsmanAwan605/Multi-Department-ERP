...
class AdminQATFuelCD70Controller extends Controller
{
    public function index(){
        $tubes = TubeFuelCD70::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.tfuelCD70.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.tfuelCD70.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/tfuelCD-70');
    ...
    public function edit(string $id){
        ...
        return view('admin.final.tfuelCD70.edit')->with(compact('tube'));
