...
class QATBBreatherCD70Controller extends Controller
{
    public function index(){
        $tubes = TubeBBreatherCD70::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tbBreatherCD70.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tbBreatherCD70.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tbBreather-CD70');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tbBreatherCD70.edit')->with(compact('tube'));
