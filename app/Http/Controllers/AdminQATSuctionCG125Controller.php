...
class AdminQATSuctionCG125Controller extends Controller
{
    public function index(){
        $tubes = TubeSuctionCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.tSuctionCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.tSuctionCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/tSuctionCG125');
    ...
    public function edit(string $id){
        ...
        return view('admin.final.tSuctionCG125.edit')->with(compact('tube'));
