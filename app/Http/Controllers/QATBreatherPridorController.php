...
class QATBreatherPridorController extends Controller
{
    public function index(){
        $tubes = TubeBreatherPridor::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tBreatherPridor.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tBreatherPridor.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tBreatherPridor');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tBreatherPridor.edit')->with(compact('tube'));
