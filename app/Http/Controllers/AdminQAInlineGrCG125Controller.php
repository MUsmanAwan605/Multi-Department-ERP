...
class AdminQAInlineGrCG125Controller extends Controller
{
    public function index(){
        $tubes = InlineGrmtCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.GrmtCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.GrmtCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/GrmtCG125');
    ...
    public function edit(string $id){
        ...
        return view('admin.inline.GrmtCG125.edit')->with(compact('tube'));
