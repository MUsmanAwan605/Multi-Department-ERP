...
class AdminQAXRController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.XR.index')->with(compact('charts'));
    ...
    {
        $chart = XR::find($id);
        return view('admin.XR.edit')->with(compact('chart'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('admin.XR.view',['meanIds' => $meanIds,'meanValues' => $meanValues,'rangeIds' => $rangeIds,'rangeValues' => $rangeValues],compact('records','date1','date2','X_UCL','R_UCL','X_LCL','R_LCL','ttl_mean','overallRange','ttl_Xi_Xbar_sq','USL','LSL','var','st_dev','cp','cpu','cpl','cpk'));
    }
}
