...
class QATFuelCG125Controller extends Controller
{
    public function index(){
        $tubes = TubeFuelCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tfuelCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tfuelCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tfuelCG-125');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tfuelCG125.edit')->with(compact('tube'));
