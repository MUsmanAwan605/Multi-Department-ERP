...
class QATBreatherKOKAController extends Controller
{
    public function index(){
        $tubes = TubeBreatherKOKA::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tBreatherKOKA.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tBreatherKOKA.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tBreatherKOKA');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tBreatherKOKA.edit')->with(compact('tube'));
