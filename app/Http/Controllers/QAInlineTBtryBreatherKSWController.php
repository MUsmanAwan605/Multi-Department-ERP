...
class QAInlineTBtryBreatherKSWController extends Controller
{
    public function index(){
        $tubes = InlineTubeBtryBreatherKSW::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tBatteryBreatherKSW.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tBatteryBreatherKSW.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tBtryBreatherKSW');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tBatteryBreatherKSW.edit')->with(compact('tube'));
