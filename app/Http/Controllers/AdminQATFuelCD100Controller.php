...
class AdminQATFuelCD100Controller extends Controller
{
    public function index(){
        $tubes = TubeFuelCD100::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.tfuelCD100.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.tfuelCD100.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/tfuelCD-100');

    }

    public function edit(string $id){

        $tube = TubeFuelCD100::find($id);
        return view('admin.final.tfuelCD100.edit')->with(compact('tube'));
