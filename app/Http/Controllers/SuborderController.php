...
class SuborderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('/store/subsupplierrr/order')->with('success', 'Order Added successfully.');
...
$order->update([
    ...
    'supplier'=>request()->get('spname')
        ...
        return redirect()->to(route('suborder.index'))->with('success', 'Order Update successfully.');
    }
    ...
    public function destroy(string $id)
    {
        $order = Suborder::find($id);
        $order->delete();
        return redirect()->to(route('suborder.index'))->with('success', 'Order Delete successfully.');
    }
