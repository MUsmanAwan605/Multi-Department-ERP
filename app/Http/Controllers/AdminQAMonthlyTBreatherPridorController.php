...
class AdminQAMonthlyTBreatherPridorController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.monthly.tBreatherPridor.index')->with(compact('tubes'));
    ...
    {
        return view('admin.monthly.tBreatherPridor.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('admin/monthly/tBreatherPridor');
    }
    ...
    public function view(Request $request){
        ...
        return view('admin.monthly.tBreatherPridor.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.monthly.tBreatherPridor.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('admin.monthly.tBreatherPridor.view',compact('records','data'));
    }
}
