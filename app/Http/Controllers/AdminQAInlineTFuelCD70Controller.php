...
class AdminQAInlineTFuelCD70Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeFuelCD70::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tfuelCD70.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tfuelCD70.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/tfuelCD-70');

    }

    public function edit(string $id){

        $tube = InlineTubeFuelCD70::find($id);
        return view('admin.inline.tfuelCD70.edit')->with(compact('tube'));
