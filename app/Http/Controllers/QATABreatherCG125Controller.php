...
class QATABreatherCG125Controller extends Controller
{
    public function index(){
        $tubes = TubeABreatherCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.taBreatherCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.taBreatherCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/taBreather-CG125');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.taBreatherCG125.edit')->with(compact('tube'));
