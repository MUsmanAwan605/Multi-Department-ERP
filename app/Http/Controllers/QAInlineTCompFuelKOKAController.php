...
class QAInlineTCompFuelKOKAController extends Controller
{
    public function index(){
        $tubes = InlineTubeCompFuelKOKA::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tCompfuelKOKA.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tCompfuelKOKA.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tCompfuelKOKA');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tCompfuelKOKA.edit')->with(compact('tube'));
