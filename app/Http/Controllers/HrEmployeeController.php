...
class   HrEmployeeController extends Controller
{
    ...
    $this->validate($request, [
        ...
        return redirect()->route('hr.employee.index')->with('success', 'Employee added successfully.');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('hr.Employee.edit')->with(compact('Employee','departments'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('hr.employee.index')->with('success', 'Employee Update successfully.');
    ...
    public function destroy(string $id)
    {
        $Employee=Employee::find($id);
            $Employee->delete();
            return redirect()->route('hr.employee.index')->with('success', 'Employee Delete successfully.');

    }

    public function Employee_hiring(Request $request)
    {
        ...
        return view('hr.Employee.view',compact('searchQuery','records'));
