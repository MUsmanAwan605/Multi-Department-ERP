...
class QATBtryBreatherKSWController extends Controller
{
    public function index(){
        $tubes = TubeBtryBreatherKSW::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tBatteryBreatherKSW.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tBatteryBreatherKSW.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tBtryBreatherKSW');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tBatteryBreatherKSW.edit')->with(compact('tube'));
