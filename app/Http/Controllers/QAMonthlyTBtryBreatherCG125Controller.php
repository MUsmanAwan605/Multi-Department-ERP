...
class QAMonthlyTBtryBreatherCG125Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('quality.monthly.tBatteryBreatherCG125.index')->with(compact('tubes'));
    ...
    {
        return view('quality.monthly.tBatteryBreatherCG125.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('qa/monthly/tBtryBreatherCG125');
    }
    ...
    public function view(Request $request){
        ...
        return view('quality.monthly.tBatteryBreatherCG125.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('quality.monthly.tBatteryBreatherCG125.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('quality.monthly.tBatteryBreatherCG125.view',compact('records','data'));
    }
}
