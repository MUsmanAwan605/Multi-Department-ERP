...
class QACapabilityController extends Controller
{
    /**
    ...
    public function index()
    {
       ...
       return view('quality.capability.index')->with(compact('reports'));
    }
    ...
    {
        return view('quality.capability.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('qa/capability');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('quality.capability.edit')->with(compact('report'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('quality.capability.view',compact('records','date1','date2','X_bar','max','min','range','stdev','stdev_six','stdev_three','no_sample','k','cp','cpk','cp_upper','cp_lower'));
