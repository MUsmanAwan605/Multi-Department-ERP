...
class QATBtryBreatherCD100Controller extends Controller
{
    public function index(){
        $tubes = TubeBtryBreatherCD100::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tBatteryBreatherCD100.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tBatteryBreatherCD100.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tBtryBreatherCD100');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tBatteryBreatherCD100.edit')->with(compact('tube'));
