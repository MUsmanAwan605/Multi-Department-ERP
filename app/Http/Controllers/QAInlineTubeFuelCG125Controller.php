...
class QAInlineTubeFuelCG125Controller extends Controller
{
    /**
    ...
    public function index(){
        ...
        return view('quality.inline.tfuelCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tfuelCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tfuelCG125');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tfuelCG125.edit')->with(compact('tube'));
