...
class QAInlineTSuctionCG125Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeSuctionCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tSuctionCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tSuctionCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tSuctionCG125');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tSuctionCG125.edit')->with(compact('tube'));
