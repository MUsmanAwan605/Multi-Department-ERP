...
class QAInlineTBreatherPridorController extends Controller
{
    public function index(){
        $tubes = InlineTubeBreatherPridor::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tBreatherPridor.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tBreatherPridor.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tBreatherPridor');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tBreatherPridor.edit')->with(compact('tube'));
