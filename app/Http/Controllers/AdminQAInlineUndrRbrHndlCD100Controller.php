...
class AdminQAInlineUndrRbrHndlCD100Controller extends Controller
{
    public function index(){
        $tubes = InlineUndrRbrHndlCD100::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.UndrRbrHndlCD100.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.UndrRbrHndlCD100.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/UndrRbrHndlCD100');
    ...
    public function edit(string $id){
        ...
        return view('admin.inline.UndrRbrHndlCD100.edit')->with(compact('tube'));
