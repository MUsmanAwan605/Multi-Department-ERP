...
class QAInlineTBBreatherCG125Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeBBreatherCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tbBreatherCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tbBreatherCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tbBreather-CG125');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tbBreatherCG125.edit')->with(compact('tube'));
