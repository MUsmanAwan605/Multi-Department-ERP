...
class QAInlineTASVControlCG125Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeASVCntrlCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tControlASVCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tControlASVCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tASV-CG125');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tControlASVCG125.edit')->with(compact('tube'));
