...
class AdminQAT8X150CG125Controller extends Controller
{
    public function index(){
        $tubes = Tube8X150CG125::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.t8X150CG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.t8X150CG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/t8X150CG125');

    }

    public function edit(string $id){

        $tube = Tube8X150CG125::find($id);
        return view('admin.final.t8X150CG125.edit')->with(compact('tube'));
