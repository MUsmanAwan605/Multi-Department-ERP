...
class QAInlineTSuctionKOKAController extends Controller
{
    public function index(){
        $tubes = InlineTubeSuctionKOKA::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tSuctionKOKA.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tSuctionKOKA.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tSuctionKOKA');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tSuctionKOKA.edit')->with(compact('tube'));
