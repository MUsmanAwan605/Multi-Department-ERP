...
class AdminQATBtryBreatherCD100Controller extends Controller
{
    public function index(){
        $tubes = TubeBtryBreatherCD100::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.tBatteryBreatherCD100.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.tBatteryBreatherCD100.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/tBtryBreatherCD100');

    }

    public function edit(string $id){

        $tube = TubeBtryBreatherCD100::find($id);
        return view('admin.final.tBatteryBreatherCD100.edit')->with(compact('tube'));
