...
class AdminQAInlineTBtryBreatherCD70Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeBtryBreatherCD70::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tBatteryBreatherCD70.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tBatteryBreatherCD70.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/tBtryBreatherCD70');
    ...
    public function edit(string $id){
        ...
        return view('admin.inline.tBatteryBreatherCD70.edit')->with(compact('tube'));
