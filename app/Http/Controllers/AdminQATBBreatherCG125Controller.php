...
class AdminQATBBreatherCG125Controller extends Controller
{
    public function index(){
        $tubes = TubeBBreatherCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.tbBreatherCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.tbBreatherCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/tbBreather-CG125');

    }

    public function edit(string $id){

        $tube = TubeBBreatherCG125::find($id);
        return view('admin.final.tbBreatherCG125.edit')->with(compact('tube'));
    ...
    //     $results = TubeBBreatherCG125::where('extr_btm_lyr', 'like', "%$search%")->get();
    // return view('admin.products.tbBreatherCG125.index',compact('results'));
    // }
}
