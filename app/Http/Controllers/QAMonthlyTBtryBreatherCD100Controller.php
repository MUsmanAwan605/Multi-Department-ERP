...
class QAMonthlyTBtryBreatherCD100Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('quality.monthly.tBatteryBreatherCD100.index')->with(compact('tubes'));
    ...
    {
        return view('quality.monthly.tBatteryBreatherCD100.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('qa/monthly/tBtryBreatherCD100');
    }
    ...
    public function view(Request $request){
        ...
        return view('quality.monthly.tBatteryBreatherCD100.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('quality.monthly.tBatteryBreatherCD100.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('quality.monthly.tBatteryBreatherCD100.view',compact('records','data'));
    }
}
