...
class QAMonthlyTASVControlCG125Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('quality.monthly.tControlASVCG125.index')->with(compact('tubes'));
    ...
    {
        return view('quality.monthly.tControlASVCG125.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('qa/monthly/tASV-CG125');
    }
    ...
    public function view(Request $request){
        ...
        return view('quality.monthly.tControlASVCG125.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('quality.monthly.tControlASVCG125.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('quality.monthly.tControlASVCG125.view',compact('records','data'));
    }
}
