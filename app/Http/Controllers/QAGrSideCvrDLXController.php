...
class QAGrSideCvrDLXController extends Controller
{
    public function index(){
        $tubes = GrmtSideCvrDLX::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.GrmtSideCvrDLX.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.GrmtSideCvrDLX.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/GrmtSideCvrDLX');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.GrmtSideCvrDLX.edit')->with(compact('tube'));
