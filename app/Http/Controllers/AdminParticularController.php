...
class AdminParticularController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to(route('adminparticular.index'))->with('success', 'Particular Added successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->to(route('adminparticular.index'))->with('success', 'Particular Update successfully.');
    }
    ...
    public function destroy(string $id)
    {
        $particular = Particular::find($id);
        $particular->delete();
        return redirect()->to(route('adminparticular.index'))->with('success', 'Particular Delete successfully.');
    }
