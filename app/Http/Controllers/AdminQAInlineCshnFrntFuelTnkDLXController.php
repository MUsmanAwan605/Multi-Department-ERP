...
class AdminQAInlineCshnFrntFuelTnkDLXController extends Controller
{
    public function index(){
        $tubes = InlineCshnFrntFuelTnkDLX::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.CshnFrntFuelTnkDLX.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.CshnFrntFuelTnkDLX.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/CshnFrntFuelTnkDLX');
    ...
    public function edit(string $id){
        ...
        return view('admin.inline.CshnFrntFuelTnkDLX.edit')->with(compact('tube'));
