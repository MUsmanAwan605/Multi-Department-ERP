...
class QAInlineTBtryBreatherCD100Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeBtryBreatherCD100::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tBatteryBreatherCD100.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tBatteryBreatherCD100.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tBtryBreatherCD100');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tBatteryBreatherCD100.edit')->with(compact('tube'));
