...
class AdminQATABreatherCG125Controller extends Controller
{
    public function index(){
        $tubes = TubeABreatherCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.taBreatherCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.taBreatherCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/taBreather-CG125');

    }

    public function edit(string $id){

        $tube = TubeABreatherCG125::find($id);
        return view('admin.final.taBreatherCG125.edit')->with(compact('tube'));
