...
class AdminQAInlineTCompFuelDeluxeController extends Controller
{
    public function index(){
        $tubes = InlineTubeCompFuelDLX::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tCompFuelDeluxe.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tCompFuelDeluxe.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/tCompFuelDLX');

    }

    public function edit(string $id){

        $tube = InlineTubeCompFuelDLX::find($id);
        return view('admin.inline.tCompFuelDeluxe.edit')->with(compact('tube'));
