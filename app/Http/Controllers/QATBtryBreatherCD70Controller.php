...
class QATBtryBreatherCD70Controller extends Controller
{
    public function index(){
        $tubes = TubeBtryBreatherCD70::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tBatteryBreatherCD70.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tBatteryBreatherCD70.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tBtryBreatherCD70');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tBatteryBreatherCD70.edit')->with(compact('tube'));
