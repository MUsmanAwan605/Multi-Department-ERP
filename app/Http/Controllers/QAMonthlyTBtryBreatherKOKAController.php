...
class QAMonthlyTBtryBreatherKOKAController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('quality.monthly.tBatteryBreatherKOKA.index')->with(compact('tubes'));
    ...
    {
        return view('quality.monthly.tBatteryBreatherKOKA.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('qa/monthly/tBtryBreatherKOKA');
    }
    ...
    public function view(Request $request){
        ...
        return view('quality.monthly.tBatteryBreatherKOKA.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('quality.monthly.tBatteryBreatherKOKA.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('quality.monthly.tBatteryBreatherKOKA.view',compact('records','data'));
    }
}
