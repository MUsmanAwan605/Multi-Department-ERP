...
class QATBBreatherCG125Controller extends Controller
{
    public function index(){
        $tubes = TubeBBreatherCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tbBreatherCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tbBreatherCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tbBreather-CG125');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tbBreatherCG125.edit')->with(compact('tube'));
    ...
    // return view('quality.products.tbBreatherCG125.index',compact('results'));
    // }
}
