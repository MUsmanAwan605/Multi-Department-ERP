...
class QAT8X150CG125Controller extends Controller
{
    public function index(){
        $tubes = Tube8X150CG125::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.t8X150CG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.t8X150CG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/t8X150CG125');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.t8X150CG125.edit')->with(compact('tube'));
