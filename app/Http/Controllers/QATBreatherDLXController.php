...
class QATBreatherDLXController extends Controller
{
    public function index(){
        $tubes = TubeBreatherDLX::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tBreatherDeluxe.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tBreatherDeluxe.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tBreatherDeluxe');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tBreatherDeluxe.edit')->with(compact('tube'));
