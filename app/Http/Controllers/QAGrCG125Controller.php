...
class QAGrCG125Controller extends Controller
{
    public function index(){
        $tubes = GrmtCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.GrmtCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.GrmtCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/GrmtCG125');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.GrmtCG125.edit')->with(compact('tube'));
