...
class AdminQAInlineTBreatherPridorController extends Controller
{
    public function index(){
        $tubes = InlineTubeBreatherPridor::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tBreatherPridor.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tBreatherPridor.add');
    }
    public function store(Request $request){
        ...
        InlineTubeBreatherPridor::create([
        ...
        return redirect()->to('/admin/inline/tBreatherPridor');

    }

    public function edit(string $id){

        $tube = InlineTubeBreatherPridor::find($id);
        return view('admin.inline.tBreatherPridor.edit')->with(compact('tube'));
