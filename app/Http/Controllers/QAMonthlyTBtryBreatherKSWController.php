...
class QAMonthlyTBtryBreatherKSWController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('quality.monthly.tBatteryBreatherKSW.index')->with(compact('tubes'));
    ...
    {
        return view('quality.monthly.tBatteryBreatherKSW.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('qa/monthly/tBtryBreatherKSW');
    }
    ...
    public function view(Request $request){
        ...
        return view('quality.monthly.tBatteryBreatherKSW.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('quality.monthly.tBatteryBreatherKSW.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('quality.monthly.tBatteryBreatherKSW.view',compact('records','data'));
    }
}
