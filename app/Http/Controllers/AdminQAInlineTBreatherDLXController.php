...
class AdminQAInlineTBreatherDLXController extends Controller
{
    public function index(){
        $tubes = InlineTubeBreatherDLX::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tBreatherDeluxe.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tBreatherDeluxe.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/tBreatherDeluxe');
    ...
    public function edit(string $id){
        ...
        return view('admin.inline.tBreatherDeluxe.edit')->with(compact('tube'));
