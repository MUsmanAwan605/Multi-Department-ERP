...
class AdminQAInlineTBtryBreatherCD100Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeBtryBreatherCD100::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tBatteryBreatherCD100.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tBatteryBreatherCD100.add');
    }
    public function store(Request $request){
        ...
        InlineTubeBtryBreatherCD100::create([
        ...
        return redirect()->to('/admin/inline/tBtryBreatherCD100');

    }

    public function edit(string $id){

        $tube = InlineTubeBtryBreatherCD100::find($id);
        return view('admin.inline.tBatteryBreatherCD100.edit')->with(compact('tube'));
