...
class AdminInventoryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view("admin.store.inventory.add",compact('Subsuppliers','departments'));
    ...
    public function store(Request $request)
    {
        ...
        Inventory::create([
         ...
         return redirect()->to(route('admininventory.index'))->with('success', 'Inventory Added successfully.');
    ...
    public function edit(string $id)
    {
        ...
        $Subsuppliers=Subsupplier::all();
        $departments=Department::all();
        return view("admin.store.inventory.edit",compact('Subsuppliers','departments','inventory'));
        // return view("admin.store/inventory/edit")->with(compact());
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->to(route('admininventory.index'))->with('success', 'Inventory Update successfully.');
    }
    ...
    public function destroy(string $id)
    {
        $inventory = Inventory::find($id);
        $inventory->delete();
        return redirect()->to(route('admininventory.index'))->with('success', 'Inventory Delete successfully.');
    ...
    public function search(Request $request)
    {
        ...
        $records=Inventory::where(function($query) use ($searchQuery){
                $query->orWhere('supp_name','LIKE',"%{$searchQuery}%");
                })->paginate(8);
