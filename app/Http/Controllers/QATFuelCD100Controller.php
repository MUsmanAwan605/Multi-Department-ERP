...
class QATFuelCD100Controller extends Controller
{
    public function index(){
        $tubes = TubeFuelCD100::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tfuelCD100.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tfuelCD100.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tfuelCD-100');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tfuelCD100.edit')->with(compact('tube'));
