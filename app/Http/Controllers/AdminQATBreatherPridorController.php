...
class AdminQATBreatherPridorController extends Controller
{
    public function index(){
        $tubes = TubeBreatherPridor::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.tBreatherPridor.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.tBreatherPridor.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/tBreatherPridor');

    }

    public function edit(string $id){

        $tube = TubeBreatherPridor::find($id);
        return view('admin.final.tBreatherPridor.edit')->with(compact('tube'));
