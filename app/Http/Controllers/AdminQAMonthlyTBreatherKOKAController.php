...
class AdminQAMonthlyTBreatherKOKAController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.monthly.tBreatherKOKA.index')->with(compact('tubes'));
    ...
    {
        return view('admin.monthly.tBreatherKOKA.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('admin/monthly/tBreatherKOKA');
    }
    ...
    public function view(Request $request){
        ...
        return view('admin.monthly.tBreatherKOKA.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.monthly.tBreatherKOKA.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('admin.monthly.tBreatherKOKA.view',compact('records','data'));
    }
}
