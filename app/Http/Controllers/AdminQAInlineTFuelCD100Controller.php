...
class AdminQAInlineTFuelCD100Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeFuelCD100::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tfuelCD100.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tfuelCD100.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/tfuelCD-100');

    }

    public function edit(string $id){

        $tube = InlineTubeFuelCD100::find($id);
        return view('admin.inline.tfuelCD100.edit')->with(compact('tube'));
