...
class AdminQAMonthlyTBreatherDLXController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.monthly.tBreatherDeluxe.index')->with(compact('tubes'));
    ...
    {
        return view('admin.monthly.tBreatherDeluxe.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('admin/monthly/tBreatherDeluxe');
    }
    ...
    public function view(Request $request){
        ...
        return view('admin.monthly.tBreatherDeluxe.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.monthly.tBreatherDeluxe.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('admin.monthly.tBreatherDeluxe.view',compact('records','data'));
    }
}
