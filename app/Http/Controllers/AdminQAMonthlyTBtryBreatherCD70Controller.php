...
class AdminQAMonthlyTBtryBreatherCD70Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.monthly.tBatteryBreatherCD70.index')->with(compact('tubes'));
    ...
    {
        return view('admin.monthly.tBatteryBreatherCD70.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('admin/monthly/tBtryBreatherCD70');
    }
    ...
    public function view(Request $request){
        ...
        return view('admin.monthly.tBatteryBreatherCD70.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.monthly.tBatteryBreatherCD70.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('admin.monthly.tBatteryBreatherCD70.view',compact('records','data'));
    }
}
