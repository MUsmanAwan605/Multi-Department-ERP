...
class AdminQAInlineTBreatherKOKAController extends Controller
{
    public function index(){
        $tubes = InlineTubeBreatherKOKA::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tBreatherKOKA.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tBreatherKOKA.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/tBreatherKOKA');
    ...
    public function edit(string $id){
        ...
        return view('admin.inline.tBreatherKOKA.edit')->with(compact('tube'));
