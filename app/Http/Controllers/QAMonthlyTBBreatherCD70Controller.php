...
class QAMonthlyTBBreatherCD70Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('quality.monthly.tbBreatherCD70.index')->with(compact('tubes'));
    ...
    {
        return view('quality.monthly.tbBreatherCD70.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('qa/monthly/tbBreather-CD70');
    }
    ...
    public function view(Request $request){
        ...
        return view('quality.monthly.tbBreatherCD70.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('quality.monthly.tbBreatherCD70.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('quality.monthly.tbBreatherCD70.view',compact('records','data'));
    }
}
