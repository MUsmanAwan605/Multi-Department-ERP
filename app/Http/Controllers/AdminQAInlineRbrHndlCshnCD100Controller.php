...
class AdminQAInlineRbrHndlCshnCD100Controller extends Controller
{
    public function index(){
        $tubes = InlineRbrHndlCshnCD100::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.RbrHndlCshnCD100.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.RbrHndlCshnCD100.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/inline/RbrHndlCshnCD100');
    ...
    public function edit(string $id){
        ...
        return view('admin.inline.RbrHndlCshnCD100.edit')->with(compact('tube'));
