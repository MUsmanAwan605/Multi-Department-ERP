...
class QAInlineGrSideCvrDLXController extends Controller
{
    public function index(){
        $tubes = InlineGrmtSideCvrDLX::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.GrmtSideCvrDLX.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.GrmtSideCvrDLX.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/GrmtSideCvrDLX');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.GrmtSideCvrDLX.edit')->with(compact('tube'));
