...
class QAPChartController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('quality.pchart.index')->with(compact('charts'));
    ...
    {
        return view('quality.pchart.add');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('quality.pchart.edit')->with(compact('chart'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('quality.pchart.view',['prblmIds' => $prblmIds,'prblmValues' => $prblmValues],compact('records','date1','date2','ttl_pin_hole','ttl_air_bbl','ttl_clr_out','ttl_taper_ctng','ttl_extr_bnd_agnt','ttl_rst_clp','ttl_ms_prnt','ttl_no_prblm','prblm_prcnt'));
    }
}
