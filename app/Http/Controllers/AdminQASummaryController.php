...
class AdminQASummaryController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.summary.index')->with(compact('summaries','finalRejections'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('admin/summary/quality');
    ...
    public function search_data(Request $request){
        ...
        return view('admin.summary.view',compact('records','data','finalRejections'));
    }
}
