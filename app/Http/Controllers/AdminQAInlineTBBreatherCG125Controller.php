...
class AdminQAInlineTBBreatherCG125Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeBBreatherCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.inline.tbBreatherCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.inline.tbBreatherCG125.add');
    }
    public function store(Request $request){
        ...
        InlineTubeBBreatherCG125::create([
        ...
        return redirect()->to('/admin/inline/tbBreather-CG125');

    }

    public function edit(string $id){

        $tube = InlineTubeBBreatherCG125::find($id);
        return view('admin.inline.tbBreatherCG125.edit')->with(compact('tube'));
