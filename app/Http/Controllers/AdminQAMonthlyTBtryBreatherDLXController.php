...
class AdminQAMonthlyTBtryBreatherDLXController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.monthly.tBatteryBreatherDLX.index')->with(compact('tubes'));
    ...
    {
        return view('admin.monthly.tBatteryBreatherDLX.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('admin/monthly/tBtryBreatherDLX');
    }
    ...
    public function view(Request $request){
        ...
        return view('admin.monthly.tBatteryBreatherDLX.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.monthly.tBatteryBreatherDLX.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('admin.monthly.tBatteryBreatherDLX.view',compact('records','data'));
    }
}
