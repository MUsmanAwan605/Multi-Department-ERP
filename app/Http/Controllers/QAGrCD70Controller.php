...
class QAGrCD70Controller extends Controller
{
    public function index(){
        $tubes = GrmtCD70::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.GrmtCD70.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.GrmtCD70.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/GrmtCD70');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.GrmtCD70.edit')->with(compact('tube'));
