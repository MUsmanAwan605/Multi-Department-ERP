...
class QATBtryBreatherCG125Controller extends Controller
{
    public function index(){
        $tubes = TubeBtryBreatherCG125::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tBatteryBreatherCG125.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tBatteryBreatherCG125.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tBtryBreatherCG125');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tBatteryBreatherCG125.edit')->with(compact('tube'));
