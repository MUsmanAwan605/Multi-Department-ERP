...
class QATCompFuelDLXController extends Controller
{
    public function index(){
        $tubes = TubeCompFuelDLX::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.final.tCompFuelDlx.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.final.tCompFuelDlx.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/product/tubeCompFuelDeluxe');
    ...
    public function edit(string $id){
        ...
        return view('quality.final.tCompFuelDlx.edit')->with(compact('tube'));
