...
class AdminQAMonthlyTFuelCD70Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.monthly.tfuelCD70.index')->with(compact('tubes'));
    ...
    {
        return view('admin.monthly.tfuelCD70.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('admin/monthly/tfuelCD-70');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.monthly.tfuelCD70.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('admin.monthly.tfuelCD70.view',compact('records','data'));
    }
}
