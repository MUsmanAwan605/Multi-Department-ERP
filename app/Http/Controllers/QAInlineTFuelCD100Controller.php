...
class QAInlineTFuelCD100Controller extends Controller
{
    public function index(){
        $tubes = InlineTubeFuelCD100::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tfuelCD100.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tfuelCD100.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tfuelCD-100');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tfuelCD100.edit')->with(compact('tube'));
