...
class AdminQAMonthlyGrSideCvrDLXController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.monthly.GrmtSideCvrDLX.index')->with(compact('tubes'));
    ...
    {
        return view('admin.monthly.GrmtSideCvrDLX.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('admin/monthly/GrmtSideCvrDLX');
    }
    ...
    public function view(Request $request){
        ...
        return view('admin.monthly.GrmtSideCvrDLX.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.monthly.GrmtSideCvrDLX.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('admin.monthly.GrmtSideCvrDLX.view',compact('records','data'));
    }
}
