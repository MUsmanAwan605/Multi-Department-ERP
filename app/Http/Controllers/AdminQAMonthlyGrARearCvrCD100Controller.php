...
class AdminQAMonthlyGrARearCvrCD100Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.monthly.GrmtARearCvrCD100.index')->with(compact('tubes'));
    ...
    {
        return view('admin.monthly.GrmtARearCvrCD100.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('admin/monthly/GrmtARearCvrCD100');
    }
    ...
    public function view(Request $request){
        ...
        return view('admin.monthly.GrmtARearCvrCD100.view')->with(compact('tubes','search'));
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.monthly.GrmtARearCvrCD100.edit')->with(compact('tube'));
    }
    ...
    public function search_data(Request $request){
        ...
        return view('admin.monthly.GrmtARearCvrCD100.view',compact('records','data'));
    }
}
