...
class QAInlineTCompFuelDeluxeController extends Controller
{
    public function index(){
        $tubes = InlineTubeCompFuelDLX::orderBy('sr_no','DESC')->paginate(8);
        return view('quality.inline.tCompFuelDeluxe.index')->with(compact('tubes'));
    }
    public function create(){
        return view('quality.inline.tCompFuelDeluxe.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/qa/inline/tCompFuelDLX');
    ...
    public function edit(string $id){
        ...
        return view('quality.inline.tCompFuelDeluxe.edit')->with(compact('tube'));
