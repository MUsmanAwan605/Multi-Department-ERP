...
class AdminQAT4X440KOKAController extends Controller
{
    public function index(){
        $tubes = Tube4X440KOKA::orderBy('sr_no','DESC')->paginate(8);
        return view('admin.final.t4X440KOKA.index')->with(compact('tubes'));
    }
    public function create(){
        return view('admin.final.t4X440KOKA.add');
    }
    public function store(Request $request){
        ...
        return redirect()->to('/admin/product/t4X440KOKA');
    ...
    public function edit(string $id){
        ...
        return view('admin.final.t4X440KOKA.edit')->with(compact('tube'));
