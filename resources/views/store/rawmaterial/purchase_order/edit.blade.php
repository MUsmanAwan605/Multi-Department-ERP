            ...
            <div class="col-xl-6 mx-auto">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4">Purchase Order Edit</h5>
                        <form class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="email" class="form-control" id="qty" name="qty" placeholder="Quantity">
                            </div>
                            <div class="col-md-12">
                                <label for="input5" class="form-label">Order by</label>
                                <input type="password" class="form-control" id="order_by" name="order_by" placeholder="Order by">
                            </div>
                                             <div class="col-md-12">
