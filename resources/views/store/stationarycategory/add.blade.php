    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-lg-6 ">
                ...
                <form method="post" action="{{route('stationarycategory.store')}}">
                    @csrf
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form class="row g-3">
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="input4" class="form-label mb-0">Company Name</label>
                                <input type="text"value="{{old('CompanyName')}}" class="form-control @error('CompanyName') is-invalid @enderror" id="CompanyName" name="CompanyName" placeholder="CompanyName">
