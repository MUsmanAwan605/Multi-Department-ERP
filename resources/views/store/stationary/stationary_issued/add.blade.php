...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-8 ">
                <form method="post" action="{{route('stationary.index')}}">
                    @csrf
                <div class="card">
                        ...
                        <div class="d-flex justify-content-between col-12">
                            ...
                            <form class="row g-3">
                                ...
                                <div class="col-md-12 mb-3">
                                        ...
                                        <input type="number" value="{{old('s_no')}}" class="form-control @error('s_no') is-invalid @enderror" id="s_no" name="s_no" placeholder="Serial Number">
