				...
				<div class="card">
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
						  ...
						  <div class="ms-auto"><a href="/admin/file-upload/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>File Upload</a></div>
						</div>
						...
						<div class="table-responsive">
                                   ...
                                   <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="mb-0 font-14">{{$quality->id}}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        {{$quality->date_of_upload}}
                                    </td>
									<td><a href="/files/{{$quality->file_upload}}" download="{{$quality->file_name}}">{{$quality->file_name}}</a></td>
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="/admin/file-upload/{{$quality->id}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/file-upload/{{$quality->id}}">
												@csrf
												{{method_field('DELETE')}}
                            ...
                            <div class="mt-4">
                                ...
                                {!! $qualities->withQueryString()->links('pagination::bootstrap-5') !!}
