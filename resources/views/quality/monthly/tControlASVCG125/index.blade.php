                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/qa/monthly/tASV-CG125/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
                                            ...
                                            <a href="/qa/monthly/tASV-CG125/{{$tube->sr_no}}/destroy" class="ms-3"><i class='bx bxs-trash'></i></a>
												</button>
                                            </form>
                                        </div>
                                    </td>
