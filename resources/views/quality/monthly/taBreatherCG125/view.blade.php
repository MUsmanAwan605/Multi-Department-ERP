					...
					<div class="card-body">
                        ...
                        <div class="d-lg-flex align-items-center mb-4 gap-3">
                            <div class="col-6">
                                ...
                                <form method="get" action="{{route('search.taBreather-CG125')}}">
                                    <div class="d-lg-flex">
                                        <div class="col-8">
                                        ...
                                        <div class="ms-2">
                                            <a href="{{route('monthly.taBreather-CG125.index')}}">
						  ...
						  <div class="ms-auto"><a href="/qa/monthly/taBreather-CG125/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/qa/monthly/taBreather-CG125/{{$record->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/qa/monthly/taBreather-CG125/{{$record->sr_no}}">
												@csrf
												{{method_field('DELETE')}}
												<button type="submit" style="outline:none;border:none;background:transparent">
                                            <a href="/qa/monthly/taBreather-CG125/{{$record->sr_no}}/destroy" class="ms-3"><i class='bx bxs-trash'></i></a>
												</button>
                                            </form>
                                        </div>
                                    </td>
