				...
				<div class="card">
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
						  ...
						  <div class="ms-auto"><a href="/qa/inspectors/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspectors</a></div>
						</div>
                                   ...
                                   <tr>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="/qa/inspectors/{{$inspector->id}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/qa/inspectors/{{$inspector->id}}">
												@csrf
												{{method_field('DELETE')}}
