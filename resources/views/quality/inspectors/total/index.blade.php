				...
				<div class="card">
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
						  ...
						  <div class="ms-auto"><a href="/qa/total/inspectors/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Total Inspection</a></div>
						</div>
						@if($totals->count() > 0)
                                   ...
                                   <tr>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="/qa/total/inspectors/{{$total->id}}/edit" class=""><i class='bx bxs-edit'></i></a>
