			  ...
			  <form method="post" action="/admin/file-upload" enctype="multipart/form-data">
				...
				<div class="card">
				  <div class="card-body p-4">
					  <h5 class="card-title">Add File Upload</h5>
					  <hr/>
                        ...
                        <div class="row">
						   ...
						   <div class="mb-3">
							...
							<div class="mb-3">
								...
								<input type="text" name="file_name" id="file_name" class="form-control @error('file_name') is-invalid @enderror" value="{{old('file_name')}}" placeholder="Enter File Name">
								<span class="text-danger">{{ $errors->first('file_name') }}</span>
							</div>
							<div class="mb-3">
                                <label for="date_of_upload" class="form-label">Date Of File Upload</label>
                                <input class="form-control @error('date_of_upload') is-invalid @enderror" value="{{old('date_of_upload')}}" name="date_of_upload" type="date">
