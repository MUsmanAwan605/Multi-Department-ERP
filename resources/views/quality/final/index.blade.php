				...
				<div class="card">
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
						  ...
						  <div class="ms-auto"><a href="/qa/products/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Product</a></div>
						</div>
                                   ...
                                   <tr>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="/qa/products/{{$product->id}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/qa/products/{{$product->id}}">
												@csrf
												{{method_field('DELETE')}}
												<button type="submit" style="outline:none;border:none;background:transparent">
                                            <a href="/qa/products/{{$product->id}}/destroy" class="ms-3"><i class='bx bxs-trash'></i></a>
												</button>
                                        </div>
                                    </td>
                                </tr>
