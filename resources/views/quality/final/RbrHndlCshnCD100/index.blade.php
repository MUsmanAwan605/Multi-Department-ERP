				...
				<div class="card">
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
						  ...
						  <div class="ms-auto"><a href="/qa/product/RbrHndlCshnCD100/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center order-actions">
                                            <a href="/qa/product/RbrHndlCshnCD100/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
