		...
		<div class="page-wrapper">
			<div class="page-content">
              ...
              <div>
						  ...
						  <div class="ms-auto"><a href="/qa/inline/tfuelCG125/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inline Record</a></div>
						</div>
            @if($tubes->count() > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex order-actions">
                                                <a href="/qa/inline/tfuelCG125/{{ $tube->sr_no }}/edit"
                                                    class=""><i class='bx bxs-edit'></i></a>
                                                <form method="post"
                                                    action="/qa/inline/tfuelCG125/{{ $tube->sr_no }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
