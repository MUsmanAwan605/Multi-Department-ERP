		...
		<div class="page-wrapper">
			<div class="page-content">
              ...
              <div>
						  ...
						  <div class="ms-auto"><a href="/qa/inline/tBreatherDeluxe/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
                                  ...
                                  {{--   <td class="text-center">{{$tube->inline_rejections}}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/qa/inline/tBreatherDeluxe/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/qa/inline/tBreatherDeluxe/{{$tube->sr_no}}">
												@csrf
												{{method_field('DELETE')}}
