		...
		<div class="page-wrapper">
			<div class="page-content">
              ...
              <div>
						  ...
						  <div class="ms-auto"><a href="/qa/inline/tbBreather-CD70/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/qa/inline/tbBreather-CD70/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
