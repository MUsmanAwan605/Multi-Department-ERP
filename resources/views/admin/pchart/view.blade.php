...
@section('admin')
    <!--start page wrapper -->
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center order-actions">
                                            <a href="/admin/pchart/{{$record->id}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/pchart/{{$record->id}}">
												@csrf
												{{method_field('DELETE')}}
	   ...
	   <script src="{{asset('admin/assets/js/mychart3.js')}}"></script>
