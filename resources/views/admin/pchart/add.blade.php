    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Add P Chart Result</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/pchart">
				@csrf
				<div class="card">
                        ...
                        <div class="row">
                           ...
                           <div class="border border-3 p-4 rounded">
                             ...
                             <div class="mb-3">
									...
									<textarea class="form-control @error('descp') is-invalid @enderror" value="{{old('descp')}}" name="descp" id="descp" cols="30" rows="5">
                                    	{{old('descp')}}
                                	</textarea>
							  ...
							  <div class="mb-3">
								...
								<input type="number" class="form-control @error('pin_hole') is-invalid @enderror" value="{{old('pin_hole')}}" name="pin_hole" placeholder="Enter Pin Hole Value">
							 ...
							 <div class="mb-3">
								...
								<input type="number" class="form-control @error('air_bbl') is-invalid @enderror" value="{{old('air_bbl')}}" name="air_bbl" placeholder="Enter Air Bubble Value">
								<span class="text-danger">{{ $errors->first('air_bbl') }}</span>
							  </div>

							   <div class="mb-3">
								<label class="form-label" for="clr_out">Enter Color Out Value</label>
								<input type="number" class="form-control @error('clr_out') is-invalid @enderror" value="{{old('clr_out')}}" name="clr_out" placeholder="Enter Color Out Value">
							  ...
							  <div class="col-lg-4">
								...
								<input type="number" class="form-control @error('taper_ctng') is-invalid @enderror" value="{{old('taper_ctng')}}" name="taper_ctng" placeholder="Enter Taper Cutting Value">
								<span class="text-danger">{{ $errors->first('taper_ctng') }}</span>
									  ...
									  <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('extr_bnd_agnt') is-invalid @enderror" value="{{old('extr_bnd_agnt')}}" name="extr_bnd_agnt" placeholder="Enter Extra Bonding Agent Value">
                                        <span class="text-danger">{{ $errors->first('extr_bnd_agnt') }}</span>
                                      </div>

									   <div class="mb-3">
                                        <label class="form-label" for="rst_clp">Enter Rusted Clip Value</label>
                                        <input type="number" class="form-control @error('rst_clp') is-invalid @enderror" value="{{old('rst_clp')}}" name="rst_clp" placeholder="Enter Rusted Clip Value">
                                        <span class="text-danger">{{ $errors->first('rst_clp') }}</span>
                                      </div>

									   <div class="mb-3">
                                        <label class="form-label" for="ms_prnt">Enter Miss Printing Value</label>
                                        <input type="number" class="form-control @error('ms_prnt') is-invalid @enderror" value="{{old('ms_prnt')}}" name="ms_prnt" placeholder="Enter Miss Printing Value">
