...
@section('admin')
    <!--start page wrapper -->
					...
					<div class="card-body">
                        ...
                        <div class="d-lg-flex align-items-center mb-4 gap-3">
                            <div class="col-6">
                                ...
                                <form method="get" action="{{route('adminsearch.xr')}}">
                                    <div class="d-lg-flex">
                                        <div class="col-6">
						  ...
						  <div class="ms-auto"><a href="/admin/XR/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Result</a></div>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center order-actions">
                                            <a href="/admin/XR/{{$record->id}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/XR/{{$record->id}}">
												@csrf
												{{method_field('DELETE')}}
	   ...
	   <script src="{{asset('admin/assets/js/myindex.js')}}"></script>
@endsection
