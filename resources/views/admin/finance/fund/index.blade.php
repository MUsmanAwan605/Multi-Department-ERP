                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle">{{$fund->depart}}</td>
                                <td style="vertical-align: middle">{{$fund->descp}}</td>
                                {{-- <td style="vertical-align: middle">
                                    @if($fund->fin_img == 'Image will be here')
                                    Image will be here
                                    @else
                                ...
                                <td style="vertical-align: middle">
                                    <div class="d-flex order-actions">
                                        <a href="{{ route('admin.finance.fund.edit',$fund->id)}}" class=""><i class='bx bxs-edit'></i></a>
                                        <form method="post" action="{{ url('admin/finance/fund/' . $fund->id) }}">
                                            @csrf
                                            {{method_field('DELETE')}}
