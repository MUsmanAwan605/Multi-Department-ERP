...
@section('admin')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <!--end breadcrumb-->
            <form action="{{route('admin.finance.fund.store')}}" method="post"  >
                @csrf
            <div class="card">
                ...
                <div class="form-body mt-4">
                    ...
                    <div class="border border-3 p-4 rounded">
                        <div class="mb-3">
                            ...
                            <input type="text" name="fund" class="form-control @error('fund') is-invalid  @enderror" id="inputProductTitle" placeholder="Enter fund">
