            ...
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <form method="GET"  action="{{ route('adminfinancesearch.order') }}">
                        ...
                        <div class="ms-auto"><a href="{{ route('adminfinance.orders.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add  Order</a></div>
                </div>
                </div>
...
<script>
    function confirmOrder(orderId) {
        ...
        $.ajax({
            url: 'admin/finance/orders/' + orderId + '/confirm',
            type: 'PUT',
            headers: {
