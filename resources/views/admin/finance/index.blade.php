					 ...
					 <div class="card radius-10 border-start border-0 border-4 border-info">
						<div class="card-body">
							<div class="d-flex align-items-center">
								<div>
                                <a href="{{route('adminfinance.orders.index')}}" class="mb-0 text-secondary"><strong>Purchase Order</strong></a>
				   ...
				   <div class="col">
					<div class="card radius-10 border-start border-0 border-4 border-danger">
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
							   <a href="{{route('adminfinance.employees.index')}}" class="mb-0 text-secondary"><strong>Employee Details</strong></a>
				  ...
				  <div class="col">
					<div class="card radius-10 border-start border-0 border-4 border-success">
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
								  <a href="{{route('adminfinance.salary.index')}}" class="mb-0 text-secondary"> <strong>Monthly Salary</strong></a>
				  ...
				  <div class="col">
					<div class="card radius-10 border-start border-0 border-4 border-warning">
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
                                <a href="{{route('adminfinance.loan.index')}}" class="mb-0 text-secondary"> <strong>Loan</strong></a>
