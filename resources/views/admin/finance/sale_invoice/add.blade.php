...
@section('admin')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <!--end breadcrumb-->
            <form action="{{route('admin.finance.sale_invoice.store')}}" method="post"  >
                @csrf
            <div class="card">
            <div class="card-body p-4">
                <h5 class="card-title">Add Sale Invoice</h5>
                <hr/>
                <div class="form-body mt-4">
                    ...
                    <div class="border border-3 p-4 rounded">
                        <div class="mb-3">
                            ...
                            <input type="text" name="sale_invoice" class="form-control @error('sale_invoice') is-invalid  @enderror" id="inputProductTitle" placeholder="Enter sale_invoice">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="price" class="form-control @error('price') is-invalid  @enderror" id="inputProductTitle" placeholder="Enter pricement">
                            <span class="text-danger">{{$errors->first('price')}}</span>
                        </div>
                        <div class="mb-3">
                            <label for="inputProductTitle" class="form-label">Total</label>
                            <input type="number" name="total" class="form-control @error('total') is-invalid  @enderror" id="inputProductTitle" placeholder="Enter totalment">
