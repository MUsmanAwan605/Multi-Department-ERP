      ...
      <!--Message  End-->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="ms-auto"><a href="/admin/finance/payslip/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add payslip</a></div>
                </div>
                @if($payslips->count()>0)
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle">
                                    <div class="d-flex order-actions">
                                        <a href="{{ route('admin.finance.payslip.edit',$payslip->id)}}" class=""><i class='bx bxs-edit'></i></a>
                                        <form method="post" action="{{ url('admin/finance/payslip/' . $payslip->id) }}">
                                            @csrf
                                            {{method_field('DELETE')}}
