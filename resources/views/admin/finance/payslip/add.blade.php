...
@section('admin')
    ...
    <div class="page-wrapper">
      ...
      <!--Message  End-->
            <!--end breadcrumb-->
            <form action="{{route('admin.finance.payslip.store')}}" method="post"  >
                @csrf
            <div class="card">
            <div class="card-body p-4">
                <h5 class="card-title">Add Payslip</h5>
                <hr/>
                <div class="form-body mt-4">
                    ...
                    <div class="border border-3 p-4 rounded">
                        <div class="mb-3">
                            ...
                            <input type="text" name="e_name" class="form-control @error('e_name') is-invalid  @enderror" id="inputProductTitle" placeholder="Enter Employee Name">
                            <span class="text-danger">{{$errors->first('e_name')}}</span>
                        </div>
                        <div class="mb-3">
                            <label for="inputProductTitle" class="form-label">Employee ID</label>
                            <input type="text" name="e_id" class="form-control @error('e_id') is-invalid  @enderror" id="inputProductTitle" placeholder="Enter Employee ID">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="desig" class="form-control @error('desig') is-invalid  @enderror" id="inputProductTitle" placeholder="Enter Designation">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="b_salary" class="form-control @error('b_salary') is-invalid  @enderror" id="inputProductTitle" placeholder="Enter Basic Salary">
                            <span class="text-danger">{{$errors->first('b_salary')}}</span>
                        </div>
                        <div class="mb-3">
                            <label for="inputProductTitle" class="form-label">Allowances</label>
                            <input type="number" name="allowances" class="form-control @error('allowances') is-invalid  @enderror" id="inputProductTitle" placeholder="Enter Allowances">
                            <span class="text-danger">{{$errors->first('allowances')}}</span>
                        </div>
                        <div class="mb-3">
                            <label for="inputProductTitle" class="form-label">Gross Salary</label>
                            <input type="number" name="g_salary" class="form-control @error('g_salary') is-invalid  @enderror" id="inputProductTitle" placeholder="Enter Gross Salary">
                            <span class="text-danger">{{$errors->first('g_salary')}}</span>
                        </div>
                        <div class="mb-3">
                            <label for="inputProductTitle" class="form-label">Deductions</label>
                            <input type="number" name="deduct" class="form-control @error('deduct') is-invalid  @enderror" id="inputProductTitle" placeholder="Enter Deductions">
                            <span class="text-danger">{{$errors->first('deduct')}}</span>
                        </div>
                        <div class="mb-3">
                            <label for="inputProductTitle" class="form-label">Net Salary</label>
                            <input type="number" name="n_salary" class="form-control @error('n_salary') is-invalid  @enderror" id="inputProductTitle" placeholder="Enter Net Salary">
