					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Inspectors</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
				...
				<div class="card">
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
						  ...
						  <div class="ms-auto"><a href="/admin/inspectors/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspectors</a></div>
						</div>
                                   ...
                                   <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="mb-0 font-14">{{$inspector->id}}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        @if($inspector->profile == 'Image will be here')
                                        <img src="/uploads/imagehere.jpg" width="80" height="70" alt="">
										@else
										<img width="80" height="70" src="/uploads/{{$inspector->profile}}" alt="">
										@endif
                                    </td>
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="/admin/inspectors/{{$inspector->id}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/inspectors/{{$inspector->id}}">
												@csrf
												{{method_field('DELETE')}}
						...
						<div class="mt-3">
                            ...
                            {!! $inspectors->withquerystring()->links('pagination::bootstrap-5') !!}
                        </div>
					</div>
					@else
