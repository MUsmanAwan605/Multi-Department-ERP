					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Total Inspection</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
				...
				<div class="card">
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
						  ...
						  <div class="ms-auto"><a href="/admin/total/inspectors/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Total Inspection</a></div>
						</div>
						@if($totals->count() > 0)
                                   ...
                                   <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="mb-0 font-14">{{$total->id}}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>{{$total->month}}</td>
                                    <td>{{$total->part_name}}</td>
                                    <td>{{$total->ttl_inspct}}</td>

                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="/admin/total/inspectors/{{$total->id}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/total/inspectors/{{$total->id}}">
												@csrf
												{{method_field('DELETE')}}
						...
						<div class="mt-3">
                            ...
                            {!! $totals->withQueryString()->links('pagination::bootstrap-5') !!}
                        </div>
					</div>
					@else
