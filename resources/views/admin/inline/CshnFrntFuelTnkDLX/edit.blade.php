    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Cushion Front Fuel Tank Deluxe</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/inline/CshnFrntFuelTnkDLX/{{$tube->sr_no}}">
				@csrf
                {{method_field('put')}}
				<div class="card">
                           ...
                           <div class="border border-3 p-4 rounded">
							  ...
							  <div class="mb-3">
								...
								<select class="form-select @error('moulding') is-invalid @enderror" name="moulding" id="moulding">
									...
									<option value="Approved" {{old('moulding',$tube->moulding) == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('moulding',$tube->moulding) == 'Rejected'  ? 'selected' : NULL}}>Rejected</option>
								</select>
							  ...
							  <div class="mb-3">
								...
								<select class="form-select @error('triming') is-invalid @enderror" name="triming" id="triming">
									<option value="none">--Select Inspection Result--</option>
									<option value="Approved" {{old('triming',$tube->triming) == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('triming',$tube->triming) == 'Rejected'  ? 'selected' : NULL}}>Rejected</option>
								</select>
