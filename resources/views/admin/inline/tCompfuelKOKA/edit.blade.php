    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/inline/tCompfuelKOKA/{{$tube->sr_no}}">
				@csrf
                {{method_field('put')}}
				<div class="card">
                       ...
                       <div class="form-body mt-4">
                        <div class="row">
                           ...
                           <div class="border border-3 p-4 rounded">
							  ...
							  <div class="mb-3">
								<label class="form-label" for="ident_mrk">Select Ident Mark Result</label>
								<select class="form-select @error('ident_mrk') is-invalid @enderror" name="ident_mrk" id="ident_mrk">
									<option value="none">--Select Inspection Result--</option>
									<option value="Approved" {{old('ident_mrk',$tube->ident_mrk) == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('ident_mrk',$tube->ident_mrk) == 'Rejected' ? 'selected' : NULL}}>Rejected</option>
								</select>
								<span class="text-danger">{{ $errors->first('ident_mrk') }}</span>
							  </div>
							  <div class="mb-3">
