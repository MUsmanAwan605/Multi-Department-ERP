		...
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Inline Tube Fuel CG-125 Inline Results</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
              ...
              <div>
						  ...
						  <div class="ms-auto"><a href="/admin/inline/tfuelCG125/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inline Record</a></div>
						</div>
            @if($tubes->count() > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex order-actions">
                                                <a href="/admin/inline/tfuelCG125/{{ $tube->sr_no }}/edit"
                                                    class=""><i class='bx bxs-edit'></i></a>
                                                <form method="post"
                                                    action="/admin/inline/tfuelCG125/{{ $tube->sr_no }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
