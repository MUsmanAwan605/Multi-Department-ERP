		...
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Inline Tube Battery Breather CD-100</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
              ...
              <div>
						  ...
						  <div class="ms-auto"><a href="/admin/inline/tBtryBreatherCD100/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
							...
							<table class="table mb-0">
								<thead class="table-light">
									<tr>
										...
										<th class="text-center">Moulding Grommet</th>
										<th class="text-center">Triming Grommet</th>
										{{-- <th class="text-center">Assembly Grommet</th>
								...
								<tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">{{$tube->mldng_grmt}}</td>
                                    <td class="text-center">{{$tube->trmng_grmt}}</td>
                                    {{-- <td class="text-center">{{$tube->asmbl_grmt}}</td>
                                            ...
                                            <div class="modal-dialog ">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Tube Battery Breather CD-100</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>
                                                          <b>Extrusion(Single Layer)</b> = {{$tube->extr_sngl_lyr}}
                                                        </p>
                                                        ...
                                                        <p>
															<b>Moulding Grommet</b> = {{$tube->mldng_grmt}}
														  </p>
														  <p>
															<b>Trimmng Grommet</b> = {{$tube->trmng_grmt}}
														  </p>
														  <p>
															<b>Assembly Grommet</b> = {{$tube->asmbl_grmt}}
														  </p>
														  <p>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/inline/tBtryBreatherCD100/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/inline/tBtryBreatherCD100/{{$tube->sr_no}}">
												@csrf
												{{method_field('DELETE')}}
