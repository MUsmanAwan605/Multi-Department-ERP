		...
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Inline Tube Battery Breather Deluxe</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
              ...
              <div>
						  ...
						  <div class="ms-auto"><a href="/admin/inline/tBtryBreatherDLX/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
							...
							<table class="table mb-0">
								<thead class="table-light">
									<tr>
										...
										<th class="text-center">Semi Vulcanization</th>
										<th class="text-center">Final Cutting Tube</th>
										<th class="text-center">Complete Vulcanization</th>
                                        <th class="text-center">Washing Tube</th>
                                        <th class="text-center">Punching</th>
                                        <th class="text-center">Extrusion(Washer)</th>
										{{-- <th class="text-center">Vulcanization Washer</th>
										<th class="text-center">Final Cutting Washer</th>
										<th class="text-center">Assembly Washer</th>
								...
								<tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">{{$tube->extr_sngl_lyr}}</td>
                                    <td class="text-center">{{$tube->semi_vulcan}}</td>
                                    <td class="text-center">{{$tube->fnl_ctng_t}}</td>
                                    <td class="text-center">{{$tube->cmplt_vulcan}}</td>
                                    <td class="text-center">{{$tube->wshng_t}}</td>
                                    <td class="text-center">{{$tube->punching}}</td>
                                    <td class="text-center">{{$tube->extr_wshr}}</td>
                                    {{-- <td class="text-center">{{$tube->vulcan_wshr}}</td>
                                    <td class="text-center">{{$tube->fnl_ctng_wshr}}</td>
                                    <td class="text-center">{{$tube->asmbl_wshr}}</td>
                                            ...
                                            <div class="modal-dialog ">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Tube Battery Breather Deluxe</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>
                                                          <b>Semi Vulcanization</b> = {{$tube->semi_vulcan}}
                                                        </p>
                                                        <p>
                                                          <b>Complete Vulcanization</b> = {{$tube->cmplt_vulcan}}
                                                        </p>
                                                        <p>
                                                          <b>Washing Tube</b> = {{$tube->wshng_t}}
                                                        </p>
                                                        <p>
                                                          <b>Final Cutting Tube</b> = {{$tube->fnl_ctng_t}}
                                                        </p>


                                                        <p>
                                                          <b>Punching</b> = {{$tube->punching}}
                                                        </p>
                                                        <p>
                                                          <b> Extrusion(Washer)</b> = {{$tube->extr_wshr}}
                                                        </p>
                                                        <p>
                                                          <b>Vulcanization(Washer)</b> = {{$tube->vulcan_wshr}}
                                                        </p>
														<p>
															<b>Final Cutting(Washer)</b> = {{$tube->fnl_ctng_wshr}}
														  </p>
														  <p>
															<b>Assembly(Washer)</b> = {{$tube->asmbl_wshr}}
														  </p>
														  <p>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/inline/tBtryBreatherDLX/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/inline/tBtryBreatherDLX/{{$tube->sr_no}}">
												@csrf
												{{method_field('DELETE')}}
