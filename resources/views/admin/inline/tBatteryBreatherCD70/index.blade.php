		...
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Inline Tube Battery Breather CD-70</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
              ...
              <div>
						  ...
						  <div class="ms-auto"><a href="/admin/inline/tBtryBreatherCD70/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>

						</div>
						<div cla                        @if($tubes->count() > 0)
              s="table-responsive">
                                   ...
                                   <tr>
                                            ...
                                            <div class="modal-dialog ">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Tube Battery Breather CD-70</h5>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/inline/tBtryBreatherCD70/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/inline/tBtryBreatherCD70/{{$tube->sr_no}}">
												@csrf
												{{method_field('DELETE')}}
