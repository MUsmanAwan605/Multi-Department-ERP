    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/inline/tCompFuelDLX/{{$tube->sr_no}}">
				@csrf
                {{method_field('put')}}
				<div class="card">
				  <div class="card-body p-4">
					<div class="d-flex justify-content-between">
						<div>
							<h5 class="card-title">Edit Inline Record</h5>
						</div>
                        ...
                        <div class="row">
                           ...
                           <div class="border border-3 p-4 rounded">
							  <div class="mb-3">
								...
								<input type="date" value="{{old('date',$tube->date)}}" class="form-control @error('date') is-invalid @enderror" id="date" name="date" placeholder="Enter Field Input">
