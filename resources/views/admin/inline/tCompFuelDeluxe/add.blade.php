    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Tube Comp Fuel Deluxe Inline Results</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/inline/tCompFuelDLX">
				@csrf
				<div class="card">
				  <div class="card-body p-4">
					<div class="d-flex justify-content-between">
						<div>
							<h5 class="card-title">Add Inline Record</h5>
						</div>
