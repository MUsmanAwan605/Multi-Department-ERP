		...
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Inline Tube A Breather CG-125</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
              ...
              <div>
						  ...
						  <div class="ms-auto"><a href="/admin/inline/taBreather-CG125/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
                                   ...
                                   <tr>
                                            ...
                                            <div class="modal-dialog ">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Tube A Breather CG-125</h5>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/inline/taBreather-CG125/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
