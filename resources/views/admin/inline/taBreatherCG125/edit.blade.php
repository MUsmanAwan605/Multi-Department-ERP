    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Tube A Breather CG-125</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/inline/taBreather-CG125/{{$tube->sr_no}}">
				@csrf
                {{method_field('put')}}
				<div class="card">
                       ...
                       <div class="form-body mt-4">
                        <div class="row">
                           ...
                           <div class="border border-3 p-4 rounded">
							  ...
							  <div class="mb-3">
								<label class="form-label" for="inline_rejections">Select Inline Rejection Result</label>
								<select class="form-select @error('inline_rejections') is-invalid @enderror" name="inline_rejections" id="inline_rejections">
									<option value="none">--Select Inspection Result--</option>
									<option value="Approved" {{old('inline_rejections',$tube->inline_rejections) == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('inline_rejections',$tube->inline_rejections) == 'Rejected' ? 'selected' : NULL}}>Rejected</option>
								</select>
								<span class="text-danger">{{ $errors->first('inline_rejections') }}</span>
							  </div>
							  <div class="mb-3">
