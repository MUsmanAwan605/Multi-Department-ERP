    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/product/tBtryBreatherDLX">
				@csrf
				<div class="card">
                           ...
                           <div class="border border-3 p-4 rounded">
							  ...
							  <div class="col-4">
								...
								<select class="form-select @error('extr_wshr') is-invalid @enderror" name="extr_wshr" id="extr_wshr">
									<option value="none">--Select Inspection Result--</option>
									<option value="Approved" {{old('extr_wshr') == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('extr_wshr') == 'Rejected' ? 'selected' : NULL}}>Rejected</option>
								</select>
							  ...
							  <div class="mb-3">
								...
								<select class="form-select @error('asmbl_wshr') is-invalid @enderror" name="asmbl_wshr" id="asmbl_wshr">
									<option value="none">--Select Inspection Result--</option>
									<option value="Approved" {{old('asmbl_wshr') == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('asmbl_wshr') == 'Rejected' ? 'selected' : NULL}}>Rejected</option>
								</select>
							  ...
							  <div class="mb-3">
								...
								<select class="form-select @error('fnl_ctng_wshr') is-invalid @enderror" name="fnl_ctng_wshr" id="fnl_ctng_wshr">
									<option value="none">--Select Inspection Result--</option>
									<option value="Approved" {{old('fnl_ctng_wshr') == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('fnl_ctng_wshr') == 'Rejected' ? 'selected' : NULL}}>Rejected</option>
								</select>
							  ...
							  <div class="mb-3">
								...
								<select class="form-select @error('vulcan_wshr') is-invalid @enderror" name="vulcan_wshr" id="vulcan_wshr">
									<option value="none">--Select Inspection Result--</option>
									<option value="Approved" {{old('vulcan_wshr') == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('vulcan_wshr') == 'Rejected' ? 'selected' : NULL}}>Rejected</option>
								</select>
