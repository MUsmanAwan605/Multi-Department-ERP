    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/product/tubeCompFuelDeluxe">
				@csrf
				<div class="card">
                           ...
                           <div class="border border-3 p-4 rounded">
                              ...
                              <div class="mb-3">
								...
								<select class="form-select @error('covr_prod') is-invalid @enderror" name="covr_prod" id="covr_prod">
									<option value="none">--Select Inspection Result--</option>
									<option value="Approved" {{old('covr_prod') == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('covr_prod') == 'Rejected' ? 'selected' : NULL}}>Rejected</option>
								</select>
