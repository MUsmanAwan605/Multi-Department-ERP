				...
				<div class="card">
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
						  ...
						  <div class="ms-auto"><a href="/admin/product/tubeCompFuelDeluxe/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
							...
							<table class="table mb-0">
								<thead class="table-light">
									<tr>
										...
										<th class="text-center">Extrusion(Bottom Layer)</th>
										<th class="text-center">Extrusion(Top Layer)</th>
                                        <th class="text-center">Blanck Cutting(Top Layer)</th>
                                        <th class="text-center">Vulcanization(Top Layer)</th>
										<th class="text-center">Washing</th>
										<th class="text-center">Final Cutting(Top Layer)</th>
										<th class="text-center">Extrusion(V-Tube)</th>
										{{-- <th class="text-center">Vulcanization(V-Tube)</th>
										<th class="text-center">Final Cutting(V-Tube)</th>
										<th class="text-center">V-Tube Assembly</th>
										<th class="text-center">Date Code Printing</th>
										<th class="text-center">Clip Assembly</th>
                                        <th class="text-center">Cover Production</th>
										<th class="text-center">Tube Production</th>
								...
								<tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">{{$tube->extr_btm_lyr}}</td>
                                    <td class="text-center">{{$tube->extr_top_lyr}}</td>
                                    <td class="text-center">{{$tube->blnk_ctng_tlyr}}</td>
                                    <td class="text-center">{{$tube->vulcan_tlyr}}</td>
                                    <td class="text-center">{{$tube->washing}}</td>
                                    <td class="text-center">{{$tube->fnl_ctng_tlyr}}</td>
                                    <td class="text-center">{{$tube->extr_vtube}}</td>
                                    {{-- <td class="text-center">{{$tube->vulcan_vtube}}</td>
                                    <td class="text-center">{{$tube->fnl_ctng_vtube}}</td>
                                    <td class="text-center">{{$tube->vtube_asmbl}}</td>
                                    <td class="text-center">{{$tube->date_code_prnt}}</td>
                                    <td class="text-center">{{$tube->clip_asmbl}}</td>
                                    <td class="text-center">{{$tube->covr_prod}}</td>
                                    <td class="text-center">{{$tube->inline_rejections}}</td>
                                    <td class="text-center">{{$tube->tube_prod}}</td> --}}
									<td class="">
                                            ...
                                            <div class="modal-dialog ">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Tube Comp Fuel Deluxe</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>
                                                          <b>Extrusion(Bottom Layer)</b> = {{$tube->extr_btm_lyr}}
                                                        </p>
                                                        <p>
                                                          <b>Extrusion(Top Layer)</b> = {{$tube->extr_top_lyr}}
                                                        </p>
                                                        <p>
                                                          <b>Blanck Cutting(Top Layer)</b> = {{$tube->blnk_ctng_tlyr}}
                                                        </p>
                                                        <p>
                                                          <b>Vulcanization(Top Layer)</b> = {{$tube->vulcan_tlyr}}
                                                        </p>
                                                        <p>
                                                          <b>Washing</b> = {{$tube->washing}}
                                                        </p>
                                                        <p>
                                                          <b>Final Cutting(Top Layer)</b> = {{$tube->fnl_ctng_tlyr}}
                                                        </p>
                                                        <p>
                                                          <b>Extrusion(V-Tube)</b> = {{$tube->extr_vtube}}
                                                        </p>
                                                        <p>
                                                          <b>Vulcanization(V-Tube)</b> = {{$tube->vulcan_vtube}}
                                                        </p>
                                                        <p>
                                                          <b>Final Cutting(V-Tube)</b> = {{$tube->fnl_ctng_vtube}}
                                                        </p>
                                                        <p>
                                                          <b>V-Tube Assembly</b> = {{$tube->vtube_asmbl}}
                                                        </p>
                                                        <p>
                                                          <b>Date Code Printing</b> = {{$tube->date_code_prnt}}
                                                        </p>
                                                        <p>
                                                          <b>Clip Assembly</b> = {{$tube->clip_asmbl}}
                                                        </p>
														<p>
															<b>Cover Production</b> = {{$tube->covr_prod}}
														  </p>
                                                        <p>
                                                          <b>Tube Production</b> = {{$tube->tube_prod}}
                                                        </p>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/product/tubeCompFuelDeluxe/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
