    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/product/tBreatherDeluxe">
				@csrf
				<div class="card">
                           ...
                           <div class="border border-3 p-4 rounded">
							  ...
							  <div class="mb-3">
								...
								<select class="form-select @error('extr_snl_lyr') is-invalid @enderror" name="extr_snl_lyr" id="extr_snl_lyr">
									...
									<option value="Approved" {{old('extr_snl_lyr') == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('extr_snl_lyr') == 'Rejected' ? 'selected' : NULL}}>Rejected</option>
								</select>
							  ...
							  <div class="mb-3">
								...
								<select class="form-select @error('blnk_ctng') is-invalid @enderror" name="blnk_ctng" id="blnk_ctng">
									<option value="none">--Select Inspection Result--</option>
									<option value="Approved" {{old('blnk_ctng') == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('blnk_ctng') == 'Rejected' ? 'selected' : NULL}}>Rejected</option>
								</select>
							  ...
							  <div class="mb-3">
								...
								<select class="form-select @error('vulcan') is-invalid @enderror" name="vulcan" id="vulcan">
									<option value="none">--Select Inspection Result--</option>
									<option value="Approved" {{old('vulcan') == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('vulcan') == 'Rejected' ? 'selected' : NULL}}>Rejected</option>
								</select>
							  ...
							  <div class="mb-3">
								...
								<select class="form-select @error('fnl_ctng') is-invalid @enderror" name="fnl_ctng" id="fnl_ctng">
									<option value="none">--Select Inspection Result--</option>
									<option value="Approved" {{old('fnl_ctng') == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('fnl_ctng') == 'Rejected' ? 'selected' : NULL}}>Rejected</option>
								</select>
