    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/product/tCompfuelKOKA">
				@csrf
				<div class="card">
                           ...
                           <div class="border border-3 p-4 rounded">
							  ...
							  <div class="mb-3">
								...
								<select class="form-select @error('ident_mrk') is-invalid @enderror" name="ident_mrk" id="ident_mrk">
									<option value="none">--Select Inspection Result--</option>
									<option value="Approved" {{old('ident_mrk') == 'Approved' ? 'selected' : NULL}}>Approved</option>
									<option value="Rejected" {{old('ident_mrk') == 'Rejected' ? 'selected' : NULL}}>Rejected</option>
								</select>
