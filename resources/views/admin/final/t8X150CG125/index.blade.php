				...
				<div class="card">
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
						  ...
						  <div class="ms-auto"><a href="/admin/product/t8X150CG125/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
                                   ...
                                   <tr>
                                            ...
                                            <div class="modal-dialog ">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Tube 8 X 150 CG-125</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>
                                                          <b>Inline Rejection</b> = {{$tube->inline_rejections}}
                                                        </p>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/product/t8X150CG125/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
