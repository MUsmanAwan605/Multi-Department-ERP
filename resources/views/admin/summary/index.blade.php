					...
					<div class="card-body">
                        ...
                        <div class="d-lg-flex align-items-center mb-4 gap-3">
                            <div class="col-6">
                                ...
                                {{-- <form method="get" action="{{route('adminsearch.summary')}}">
                                    <div class="d-lg-flex">
                                        <div class="col-8">
                                            <input type="search" name="search" class="form-control" placeholder="Search By Month Date">
                                        ...
                                        <div class="ms-2">
                                            <a href="{{route('adminmonthly.summary.index')}}">
						  ...
						  <div class="ms-auto"><a href="/admin/summary/quality/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
                                   ...
                                   <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="mb-0 font-14">{{$summary->sr_no}}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>{{$summary->month}}</td>
                                    <td>{{$summary->part_name}}</td>
                                    <td>{{$summary->fnl_inspct_rjct}}</td>
                                    <td>{{$summary->prod_qty}}</td>
									<td>{{$summary->inspct_qty}}</td>

                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="/admin/summary/quality/{{$summary->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/summary/quality/{{$summary->sr_no}}">
												@csrf
												{{method_field('DELETE')}}
						...
						<div class="mt-3">
                            ...
                            {!! $summaries->withQueryString()->links('pagination::bootstrap-5') !!}
                        </div>
                        <div>
