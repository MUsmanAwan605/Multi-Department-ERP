                        ...
                        <div class="row">
                           ...
                           <div class="border border-3 p-4 rounded">
							  ...
							  <div class="mb-3">
								...
								<input type="inspct_qty" value="{{old('inspct_qty',$tube->inpct_qty)}}" class="form-control @error('inspct_qty') is-invalid @enderror" id="inspct_qty" name="inspct_qty" placeholder="Enter Field Input">
