					...
					<div class="card-body">
                        ...
                        <div class="d-lg-flex align-items-center mb-4 gap-3">
                            <div class="col-6">
                                ...
                                {{-- <form method="get" action="{{route('adminsearch.tBtryBreatherKOKA')}}">
                                    <div class="d-lg-flex">
                                        <div class="col-8">
                                        ...
                                        <div class="ms-2">
                                            <a href="{{route('adminmonthly.tBtryBreatherKOKA.index')}}">
						  ...
						  <div class="ms-auto"><a href="/admin/monthly/tBtryBreatherKOKA/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
								...
								<tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @elseif ($tube->opr_name == 'trmng_grmt')

                                        Triming Grommet

                                        @elseif ($tube->opr_name == 'mldng_grmt')

                                        Moulding Grommet

                                        @elseif ($tube->opr_name == 'asmbl_grmt')
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/monthly/tBtryBreatherKOKA/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
