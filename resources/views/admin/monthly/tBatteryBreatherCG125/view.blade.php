					...
					<div class="card-body">
                        ...
                        <div class="d-lg-flex align-items-center mb-4 gap-3">
                            <div class="col-6">
                                ...
                                <form method="get" action="{{route('adminsearch.tBtryBreatherCG125')}}">
                                    <div class="d-lg-flex">
                                        <div class="col-8">
                                        ...
                                        <div class="ms-2">
                                            <a href="{{route('adminmonthly.tBtryBreatherCG125.index')}}">
						  ...
						  <div class="ms-auto"><a href="/admin/monthly/tBtryBreatherCG125/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
								...
								<tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if ($record->opr_name == 'extr_btm_lyr')

                                        Extrusion(Bottom Layer)

                                        @elseif ($record->opr_name == 'extr_top_lyr')

                                        Extrusion(Top Layer)

                                        @elseif ($record->opr_name == 'blnk_ctng_tlyr')

                                        Blanck Cutting(Top Layer)

                                        @elseif ($record->opr_name == 'vulcan_tlyr')

                                        Vulcanization(Top Layer)

                                        @elseif ($record->opr_name == 'washing')

                                        Washing

                                        @elseif ($record->opr_name == 'fnl_ctng_tlyr')

                                        Final Cutting(Top Layer)

                                        @elseif ($record->opr_name == 'extr_vtube')

                                        Extrusion(V-Tube)

                                        @elseif ($record->opr_name == 'vulcan_vtube')

                                        Vulcanization(V-Tube)

                                        @elseif ($record->opr_name == 'fnl_ctng_vtube')

                                        Final Cutting(V-Tube)

                                        @elseif ($record->opr_name == 'vtube_asmbl')

                                        V-Tube Assembly

                                        @elseif ($record->opr_name == 'date_code_prnt')

                                        Date Code Printing

                                        @elseif ($record->opr_name == 'clip_asmbl')
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/monthly/tBtryBreatherCG125/{{$record->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/monthly/tBtryBreatherCG125/{{$record->sr_no}}">
												@csrf
												{{method_field('DELETE')}}
												<button type="submit" style="outline:none;border:none;background:transparent">
                                            <a href="/admin/monthly/tBtryBreatherCG125/{{$record->sr_no}}/destroy" class="ms-3"><i class='bx bxs-trash'></i></a>
												</button>
                                            </form>
                                        </div>
                                    </td>
