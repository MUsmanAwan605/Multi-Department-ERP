                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/monthly/tBtryBreatherCG125/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/monthly/tBtryBreatherCG125/{{$tube->sr_no}}">
												@csrf
												{{method_field('DELETE')}}
