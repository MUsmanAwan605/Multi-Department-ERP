    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/monthly/tBtryBreatherCG125">
				@csrf
				<div class="card">
                           ...
                           <div class="border border-3 p-4 rounded">
							  ...
							  <div class="mb-3">
								...
								<select name="opr_name" id="opr_name" class="form-select @error('opr_name') is-invalid	@enderror">
									...
									<option value="extr_btm_lyr">Extrusion(Bottom Layer)</option>
									<option value="extr_top_lyr">Extrusion(Top Layer)</option>
									<option value="blnk_ctng_tlyr">Blanck Cutting(Top Layer)</option>
									<option value="vulcan_tlyr">Vulcanization(Top Layer)</option>
									<option value="washing">Washing</option>
									<option value="fnl_ctng_tlyr">Final Cutting(Top Layer)</option>
									<option value="extr_vtube">Extrusion(V-Tube)</option>
									<option value="vulcan_vtube">Vulcanization(V-Tube)</option>
									<option value="fnl_ctng_vtube">Final Cutting(V-Tube)</option>
									<option value="vtube_asmbl">V-Tube Assembly</option>
									<option value="date_code_prnt">Date Code Printing</option>
									<option value="clip_asmbl">Clip Assembly</option>
								</select>
