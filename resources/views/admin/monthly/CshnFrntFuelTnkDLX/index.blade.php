								...
								<tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if ($tube->opr_name == 'moulding')

                                        Moulding

                                        @elseif ($tube->opr_name == 'triming')
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/monthly/CshnFrntFuelTnkDLX/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/monthly/CshnFrntFuelTnkDLX/{{$tube->sr_no}}">
												@csrf
												{{method_field('DELETE')}}
