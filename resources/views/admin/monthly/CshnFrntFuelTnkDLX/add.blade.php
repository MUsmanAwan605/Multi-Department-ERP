    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/monthly/CshnFrntFuelTnkDLX">
				@csrf
				<div class="card">
                           ...
                           <div class="border border-3 p-4 rounded">
							  ...
							  <div class="mb-3">
								...
								<select name="opr_name" id="opr_name" class="form-select @error('opr_name') is-invalid	@enderror">
									...
									<option value="moulding" {{old('opr_name') == 'moulding' ? 'selected' : NULL}}>Moulding</option>
									<option value="triming" {{old('opr_name') == 'triming' ? 'selected' : NULL}}>Triming</option>
