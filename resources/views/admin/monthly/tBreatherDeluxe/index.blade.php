								...
								<tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if ($tube->opr_name == 'extr_snl_lyr')

                                        Extrusion(Single Layer)



                                        @elseif ($tube->opr_name == 'blnk_ctng')

                                        Blanck Cutting

                                        @elseif ($tube->opr_name == 'vulcan')
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/monthly/tBreatherDeluxe/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
