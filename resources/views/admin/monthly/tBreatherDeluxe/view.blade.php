					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Tube Breather Deluxe Monthly Results</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
					...
					<div class="card-body">
                        ...
                        <div class="d-lg-flex align-items-center mb-4 gap-3">
                            <div class="col-6">
                                ...
                                <form method="get" action="{{route('adminsearch.tBreatherDeluxe')}}">
                                    <div class="d-lg-flex">
                                        <div class="col-8">
                                        ...
                                        <div class="ms-2">
                                            <a href="{{route('adminmonthly.tBreatherDeluxe.index')}}">
						  ...
						  <div class="ms-auto"><a href="/admin/monthly/tBreatherDeluxe/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
								...
								<tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if ($record->opr_name == 'extr_snl_lyr')

                                        Extrusion(Single Layer)



                                        @elseif ($record->opr_name == 'blnk_ctng')

                                        Blanck Cutting

                                        @elseif ($record->opr_name == 'vulcan')
                                        ...
                                        @elseif ($record->opr_name == 'fnl_ctng')
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/monthly/tBreatherDeluxe/{{$record->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/monthly/tBreatherDeluxe/{{$record->sr_no}}">
												@csrf
												{{method_field('DELETE')}}
												<button type="submit" style="outline:none;border:none;background:transparent">
                                            <a href="/admin/monthly/tBreatherDeluxe/{{$record->sr_no}}/destroy" class="ms-3"><i class='bx bxs-trash'></i></a>
												</button>
                                        </div>
                                    </td>
                                </tr>
