					...
					<div class="card-body">
                        ...
                        <div class="d-lg-flex align-items-center mb-4 gap-3">
                            <div class="col-6">
                                ...
                                {{-- <form method="get" action="{{route('adminsearch.tASVCG125')}}">
                                    <div class="d-lg-flex">
                                        <div class="col-8">
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/monthly/tASV-CG125/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
                                            ...
                                            <a href="/admin/monthly/tASV-CG125/{{$tube->sr_no}}/destroy" class="ms-3"><i class='bx bxs-trash'></i></a>
												</button>
                                            </form>
                                        </div>
                                    </td>
