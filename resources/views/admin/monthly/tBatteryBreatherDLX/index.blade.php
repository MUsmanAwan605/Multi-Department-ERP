					...
					<div class="card-body">
                        ...
                        <div class="d-lg-flex align-items-center mb-4 gap-3">
                            <div class="col-6">
                                ...
                                {{-- <form method="get" action="{{route('adminsearch.tBtryBreatherDLX')}}">
                                    <div class="d-lg-flex">
                                        <div class="col-8">
                                        ...
                                        <div class="ms-2">
                                            <a href="{{route('adminmonthly.tBtryBreatherDLX.index')}}">
						  ...
						  <div class="ms-auto"><a href="/admin/monthly/tBtryBreatherDLX/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
								...
								<tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if ($tube->opr_name == 'extr_sngl_lyr')

                                        Extrusion(Single Layer)

                                        @elseif ($tube->opr_name == 'semi_vulcan')

                                        Semi Vulcanization

                                        @elseif ($tube->opr_name == 'fnl_ctng_t')

                                        Final Cutting Tube

                                        @elseif ($tube->opr_name == 'cmplt_vulcan')

                                        Complete Vulcanization

                                        @elseif ($tube->opr_name == 'wshng_t')

                                        Washing Tube

                                        @elseif ($tube->opr_name == 'punching')

                                        Punching

                                        @elseif ($tube->opr_name == 'extr_wshr')

                                        Extrusion (Washer)

                                        @elseif ($tube->opr_name == 'vulcan_wshr')

                                        Vulcanization Washer

                                        @elseif ($tube->opr_name == 'fnl_ctng_wshr')

                                        Final Cutting Washer

                                        @elseif ($tube->opr_name == 'asmbl_wshr')
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/monthly/tBtryBreatherDLX/{{$tube->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
