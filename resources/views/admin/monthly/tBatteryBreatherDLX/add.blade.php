    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!--end breadcrumb-->
			  <form method="post" action="/admin/monthly/tBtryBreatherDLX">
				@csrf
				<div class="card">
                           ...
                           <div class="border border-3 p-4 rounded">
							  ...
							  <div class="mb-3">
								...
								<select name="opr_name" id="opr_name" class="form-select @error('opr_name') is-invalid	@enderror">
									...
									<option value="extr_wshr" {{old('opr_name') == 'extr_wshr' ? 'selected' : NULL}}>Extrusion (Washer)</option>
									<option value="vulcan_wshr" {{old('opr_name') == 'vulcan_wshr' ? 'selected' : NULL}}>Vulcanization Washer</option>
									<option value="fnl_ctng_wshr" {{old('opr_name') == 'fnl_ctng_wshr' ? 'selected' : NULL}}>Final Cutting Washer</option>
									<option value="asmbl_wshr" {{old('opr_name') == 'asmbl_wshr' ? 'selected' : NULL}}>Assembly Washer</option>
