								...
								<tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @elseif ($record->opr_name == 'extr_wshr')

                                        Extrusion (Washer)

                                        @elseif ($record->opr_name == 'vulcan_wshr')

                                        Vulcanization Washer

                                        @elseif ($record->opr_name == 'fnl_ctng_wshr')

                                        Final Cutting Washer

                                        @elseif ($record->opr_name == 'asmbl_wshr')
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/monthly/tBtryBreatherDLX/{{$record->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/monthly/tBtryBreatherDLX/{{$record->sr_no}}">
												@csrf
												{{method_field('DELETE')}}
												<button type="submit" style="outline:none;border:none;background:transparent">
                                            <a href="/admin/monthly/tBtryBreatherDLX/{{$record->sr_no}}/destroy" class="ms-3"><i class='bx bxs-trash'></i></a>
												</button>
                                            </form>
                                        </div>
                                    </td>
