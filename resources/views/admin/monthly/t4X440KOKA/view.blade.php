					...
					<div class="card-body">
                        ...
                        <div class="d-lg-flex align-items-center mb-4 gap-3">
                            <div class="col-6">
                                ...
                                <form method="get" action="{{route('adminsearch.t4X440KOKA')}}">
                                    <div class="d-lg-flex">
                                        <div class="col-8">
                                        ...
                                        <div class="ms-2">
                                            <a href="{{route('adminmonthly.t4X440KOKA.index')}}">
						  ...
						  <div class="ms-auto"><a href="/admin/monthly/t4X440KOKA/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Inspection Record</a></div>
                                   ...
                                   <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex order-actions">
                                            <a href="/admin/monthly/t4X440KOKA/{{$record->sr_no}}/edit" class=""><i class='bx bxs-edit'></i></a>
											<form method="post" action="/admin/monthly/t4X440KOKA/{{$record->sr_no}}">
												@csrf
												{{method_field('DELETE')}}
												<button type="submit" style="outline:none;border:none;background:transparent">
                                            <a href="/admin/monthly/t4X440KOKA/{{$record->sr_no}}/destroy" class="ms-3"><i class='bx bxs-trash'></i></a>
												</button>
                                            </form>
                                        </div>
                                    </td>
