                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle">
                                    <div class="d-flex order-actions">
                                        <a href="{{route('storeproduct.edit',$record->id)}}" class=""><i class='bx bxs-edit'></i></a>
                                        ...
                                        <!-- <a href="/admin/store/product/{{$record->id}}/destroy" class="ms-3"><i class='bx bxs-trash'></i></a> -->
                                    </div>
                                </td>
                            </tr>
                            @endforeach
