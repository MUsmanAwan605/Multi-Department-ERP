        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <form method="GET"  action="{{ route('adminraw-materialout.search') }}">
                        <div class="d-lg-flex">
                            <div class="col-8">
                           ...
                           <div class="ms-2">
                                 <a href="/admin/store/raw-materialout">
                  ...
                  <div class="ms-auto"><a href="{{route('adminraw-materialout.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Raw Materials</a></div>
                </div>
                @if($records->count()>0)
