				...
				<div class="card">
                    <div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
                            <form method="GET"  action="{{ route('adminsuborder.search') }}">
                                <div class="d-lg-flex">
                                    <div class="col-8">
                                   ...
                                   <div class="ms-2">
                                         <a href="/admin/store/subsupplierrr/order">
									...
									<tr>
										...
										<td>
											<div class="d-flex order-actions">
												<a href="{{route('adminsuborder.edit',$record->id)}}" class=""><i class='bx bxs-edit'></i></a>
												<form method="post" action="{{route('adminsuborder.destroy',$record->id)}}">
													@csrf
												{{method_field('DELETE')}}
