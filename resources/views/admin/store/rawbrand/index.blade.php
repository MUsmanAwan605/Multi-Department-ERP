        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <form method="GET"  action="{{ route('adminrawbrand.search') }}">
                        <div class="d-lg-flex">
                            <div class="col-8">
                            ...
                            <div class="ms-2">
                                <a href="/admin/store/rawmaterialbrand">
                ...
                {{-- </div> --}}
                     <div class="ms-auto"><a href="{{route('adminrawbrand.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Raw Brand</a></div>
                </div>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle">
                                    <div class="d-flex order-actions">
                                        <a href="{{route('adminrawbrand.edit', $rawBrand->id)}}" class=""><i class='bx bxs-edit'></i></a>
                                        <form method="post" action="{{route('adminrawbrand.destroy', $rawBrand->id)}}">
												@csrf
												{{method_field('DELETE')}}
                                                <button type="submit"
                                                onclick="return confirm('Are you sure you want to delete?')"
                                                style="outline:none;border:none;background:transparent">
                                                <a href="{{ route('adminrawbrand.destroy',['id'=>$rawBrand->id]) }}"
