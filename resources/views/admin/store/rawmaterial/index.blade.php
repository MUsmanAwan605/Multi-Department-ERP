        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <form method="GET"  action="{{ route('adminrawbrandprod.search') }}">
                        <div class="d-lg-flex">
                            <div class="col-8">
                  ...
                  <div class="ms-auto"><a href="{{ route('adminrawbrandprod.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Raw Material Products</a></div>
                </div>
                                                    ...
                                                    {{-- @endforeach --}}
                                                        ...
                                                        <td>
                                                            <div class="d-flex order-actions">
                                                                ...
                                                                <form method="POST" action="{{route('adminrawbrandprod.destroy', $rawBrandsprod->id)}}">
                                                                    @csrf
                                                                    {{ method_field('DELETE') }}
                                                                    <button type="submit" onclick="return confirm('Are you sure you want to delete?')" style="outline:none;border:none;background:transparent">
                                                                        <a href="{{ route('adminrawbrandprod.destroy',['id'=>$rawBrandsprod->id]) }}" class="ms-3"><i class='bx bxs-trash'></i></a>
                                                                    </button>
                                                                </form>
                                                            </div>
                                                        </td>
