                    ...
                    <div class="card-body p-4">
                        ...
                        <form class="row g-3">
                            <div class=" col-md-12 mb-3">
                                ...
                                <input type="number" value="{{old('s_no',$inventory->s_no)}}" class="form-control @error('s_no') is-invalid @enderror " id="s_no" name="s_no" placeholder="S.no" value="{{$inventory->s_no}}>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text"value="{{old('supp_name',$inventory->supp_name)}}" class="form-control @error('supp_name') is-invalid @enderror" id="supp_name" name="supp_name" placeholder="Supplier_name">
                                <span class="text-danger">{{ $errors->first('supp_name') }}</span>

                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="input5" class="form-label mb-0">Department Name</label>
                                <input type="text"value="{{old('dpt_name',$inventory->dpt_name)}}" class="form-control @error('dpt_name') is-invalid @enderror" id="dpt_name" name="dpt_name" placeholder="Department Name">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form class="row g-3">
                            ...
                            <div class=" col-md-12 mb-3">
                                ...
                                <input type="number"value="{{old('packets_in',$inventory->packets_in)}}" class="form-control  @error('packets_in') is-invalid @enderror" id="packets_in" name="packets_in" placeholder="Packets_in">
                                <span class="text-danger">{{ $errors->first('packets_in') }}</span>

                            </div>
                            <div class=" col-md-12 mb-3">
                                <label for="input10" class="form-label mb-0">Weight Out</label>
                                <input type="number"value="{{old('weight_out',$inventory->weight_out)}}" class="form-control  @error('weight_out') is-invalid @enderror" id="weight_out" name="weight_out" placeholder="Weight-out">
