    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                {{-- </div> --}}
                    <div class="ms-auto"><a href="{{route('adminrawmaterialproduct.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Raw Brand</a></div>
                </div>
                @if($records->count()>0)
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle">{{$record->prod}}</td>
                                ...
                                <td style="vertical-align: middle">
                                    <div class="d-flex order-actions">
                                        <a href="{{route('adminrawmaterialproduct.edit', $record->id)}}" class=""><i class='bx bxs-edit'></i></a>
                                        <form method="post" action="{{route('adminrawmaterialproduct.destroy', $record->id)}}">
												@csrf
												{{method_field('DELETE')}}
