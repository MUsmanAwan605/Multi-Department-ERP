...
@section('admin')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <!--end breadcrumb-->
            <form method="POST" action="{{ route('admin.humanresources.employee.store') }}" enctype="multipart/form-data">
                @csrf
                    <!-- Form fields -->
                    <div class="card">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('MarriedStatus') is-invalid @enderror" name="MarriedStatus" aria-label="Default select example">
                                            ...
                                            <option value="Married" {{ old('MarriedStatus') == 'Married' ? 'selected' : '' }}>Married</option>
                                            <option value="Single" {{ old('MarriedStatus') == 'Single' ? 'selected' : '' }}>Single</option>
                                        </select>
                    ...
                    <div class="border border-3 p-4 rounded mt-3">
                           <h5 class="mb-0 text-uppercase">Attach Copy Document </h5>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" value="{{ old('cv') }}" class="form-control @error('cv') is-invalid

                                    @enderror" name="cv" id="bsValidation1">
                                    <span class="text-danger text-uppercase ">{{ $errors->first('cv') }}</span>
                                    {{-- @if (old('cv') || isset($user->cv))
                                    <div class="mt-2">
                                        <a href="{{ asset('storage/' . old('cv', $user->cv)) }}" target="_blank">View Previous CV</a>
                                    </div>
                                @endif --}}
                                </div>
                                <div class="mb-3">
                                    <label for="bsValidation2" class="form-label text-black">CNIC Copy</label>
                                    <input type="file" value="{{ old('cnic_copy') }}" class="form-control @error('cnic_copy') is-invalid

                                    @enderror" name="cnic_copy" id="bsValidation2" placeholder="Address"  >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" value="{{ old('photos') }}" class="form-control @error('photos') is-invalid

                                    @enderror" name="photos" id="bsValidation4">
