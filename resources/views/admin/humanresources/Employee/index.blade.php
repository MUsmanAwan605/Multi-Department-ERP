            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <!-- Seach method Close -->
                        <!-- Add Button start -->
                        <div class="ms-auto"><a href="{{ route('admin.humanresources.employee.create') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle">
                                                <div class="d-flex order-actions">
                                                    <a href="{{ route('admin.humanresources.employee.edit', ['id' => $Employee->id]) }}"><i
                                                            class='bx bxs-edit'></i></a>

                                                    <form method="POST"
                                                        action="{{ route('admin.humanresources.employee.destroy', ['id' => $Employee->id]) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            onclick="return confirm('Are you sure you want to delete?')"
                                                            style="outline:none;border:none;background:transparent">
                                                            <a href="{{ route('admin.humanresources.employee.destroy', ['id' => $Employee->id]) }}"
