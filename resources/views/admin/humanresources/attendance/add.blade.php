                                    ...
                                    <div class="border border-3 p-4 rounded">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control @error('Date') is-invalid @enderror"
                                                name="Date" id="inputProductTitle" placeholder="Enter Date">
                                            {{-- <span class="text-danger text-uppercase ">{{ $errors->first('Date') }}</span> --}}
                                        </div>
                                        <div class="mb-3">
                                            <label for="date" class="form-label">Sererial Number</label>
                                            <input type="" class="form-control @error('Date') is-invalid @enderror"
                                                name="Date" id="inputProductTitle" placeholder="Enter Date">
                                            {{-- <span class="text-danger text-uppercase ">{{ $errors->first('Date') }}</span> --}}
                                        </div>
                                        <div class="mb-3">
                                            <label for="date" class="form-label">Date</label>
                                            <input type="file" class="form-control @error('Date') is-invalid @enderror"
                                                name="Date" id="inputProductTitle" placeholder="Enter Date">
                                            {{-- <span class="text-danger text-uppercase ">{{ $errors->first('Date') }}</span> --}}
                                        </div>
