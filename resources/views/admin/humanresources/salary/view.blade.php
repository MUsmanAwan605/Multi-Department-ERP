    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="card">
                ...
                <!-- Search Method Start-->
                        <form method="get" action="{{ route('admin.search.salary') }}">
                            <div class="d-lg-flex">
                                <div class="col-8">
                                ...
                                <div class="ms-2">
                                    <a href="/admin/humanresources/salary">
                                        ...
                                        <tr>
                                                                        ...
                                                                        <table class="table">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>{{ $record->t_s_c_m_bef_deduction }}
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="text-info">Advance Deduction
                                                                                        Amount:</td>
                                                                                    <td>{{ $record->advan_deduction_amount }}
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                            ...
                                            <td style="vertical-align: middle">
                                                <div class="d-flex order-actions">
                                                    <a href="{{ route('admin.humanresources.salary.edit',['id'=>$record->id]) }}"
                                                        class="btn btn-success">Edit</a>
                                                    <form method="POST" action="{{ route('admin.humanresources.salary.destroy',['id'=>$record->id]) }}">
                                                        @csrf
                                                        {{ method_field('DELETE') }}
                                                        <button type="submit"
                                                            onclick="return confirm('Are you sure you want to delete?')"
                                                            style="outline:none;border:none;background:transparent">
                                                            <a href="{{ route('admin.humanresources.salary.destroy',['id'=>$record->id]) }}"
