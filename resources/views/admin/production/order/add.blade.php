    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!--end breadcrumb-->
			  <form method="POST" action="{{route('adminorder.index')}}" >
				@csrf
				<div class="card">
                           ...
                           <div class="border border-3 p-4 rounded">
                            ...
                            <div class="mb-3">
                              ...
                              <div class="mb-3">
                                ...
                                <input type="text" value="{{old('defdpt')}}" class="form-control @error('defdpt') is-invalid @enderror" id="defdpt" name="defdpt">
                               ...
                               <div class="mb-3">
                                 ...
                                 <input type="integer" value="{{old('ordrnum')}}" class="form-control @error('ordrnum') is-invalid @enderror" id="ordrnum" name="ordrnum">
                                 <span class="text-danger">{{ $errors->first('ordrnum') }}</span>
									...
									<div class="mb-3">
										...
										<input type="integer" value="{{old('raw')}}" class="form-control @error('raw') is-invalid @enderror" id="raw" name="raw">
										<span class="text-danger">{{ $errors->first('raw') }}</span>
									</div>

                                    <div class="mb-3">
										<label for="amount" class="form-label">Amount</label>
										<input type="integer" value="{{old('amount')}}" class="form-control @error('amount') is-invalid @enderror" id="amount" name="amount">
                              ...
                              <div class="mb-4">
                                ...
                                <select class=" form-select @error('dpt') is-invalid @enderror"  name="dpt" id="dpt">
									    <option value="none">--Department Name--</option>
                                 <option > Store </option>
