    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!--end breadcrumb-->
                <form method="POST" action="{{ route('adminproduct.update', ['product' => $product->id]) }}">
                    @method('PUT')
                    @csrf
				<div class="card">
                        ...
                        <div class="row">
                           ...
                           <div class="border border-3 p-4 rounded">
                              ...
                              <div class="mb-3">
								...
								<input type="integer" value="{{old('qty', $product->qty)}}" class="form-control @error('qty') is-invalid @enderror" id="qty" name="qty">
