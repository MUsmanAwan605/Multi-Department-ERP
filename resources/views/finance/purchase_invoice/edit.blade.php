...
@section('finance')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <!--end breadcrumb-->
            <form action="{{ route('finance.purchase_invoice.update', ['id' => $purchase_invoice->id]) }}" method="post"  >
                @method('put')
                @csrf
            <div class="card">
            <div class="card-body p-4">
                <h5 class="card-title">Edit Purchase Invoice</h5>
                <hr/>
                <div class="form-body mt-4">
                    ...
                    <div class="border border-3 p-4 rounded">
                        ...
                        <div class="mb-3">
                            <label for="inputProductTitle" class="form-label">Unit Price</label>
                            <input type="number" name="gst" class="form-control @error('gst') is-invalid  @enderror" value="{{old('gst',$purchase_invoice->gst)}}" id="inputProductTitle" placeholder="Enter Unit Price">
