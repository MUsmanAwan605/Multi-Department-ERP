...
@section('finance')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <!--end breadcrumb-->
            <form action="{{ route('finance.sale_invoice.store') }}" method="post">
                @csrf
                <div class="card">
                                    ...
                                    <div class="border border-3 p-4 rounded">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="date"
                                                ...
                                                id="inputProductTitle" placeholder="Enter Date">
                                            <span class="text-danger">{{ $errors->first('date') }}</span>
                                        </div>

                                        <div class="mb-3">
                                            <label for="inputProductTitle" class="form-label">Sale Invoice</label>
                                            <input type="text" name="sale_invoice"
                                                class="form-control @error('sale_invoice') is-invalid  @enderror"
                                                id="inputProductTitle" placeholder="Enter sale_invoice">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('descp') is-invalid  @enderror" name="descp" id="inputProductDescription"
                                                rows="3"></textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="qty"
                                                ...
                                                id="inputProductTitle" placeholder="Enter Quantity">
