    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="ms-auto"><a href="/finance/sale_invoice/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Sale Invoice</a></div>
                </div>
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td style="vertical-align: middle">{{$sale_invoice->sale_invoice}}</td> --}}
                                <td style="vertical-align: middle">{{ \Carbon\Carbon::parse($sale_invoice->date)->format('d M Y') }}</td>

                                <td style="vertical-align: middle">{{$sale_invoice->qty}}</td>
                                <td style="vertical-align: middle">{{$sale_invoice->price}}</td>
                                <td style="vertical-align: middle">{{$sale_invoice->gst}}</td>
                                <td style="vertical-align: middle">{{$sale_invoice->total}}</td>

                                <td style="vertical-align: middle">
                                    <div class="d-flex order-actions">
                                        <a href="{{ route('finance.sale_invoice.edit',$sale_invoice->id)}}" class=""><i class='bx bxs-edit'></i></a>
                                        <form method="post" action="{{ url('/finance/sale_invoice/' . $sale_invoice->id) }}">
                                            @csrf
                                            {{method_field('DELETE')}}
