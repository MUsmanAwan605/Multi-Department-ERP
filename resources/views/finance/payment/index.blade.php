    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="ms-auto"><a href="/finance/payment/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add payment</a></div>
                </div>
                @if($payments->count()>0)
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle">
                                    <div class="d-flex order-actions">
                                        <a href="{{ route('finance.payment.edit',$payment->id)}}" class=""><i class='bx bxs-edit'></i></a>
                                        <form method="post" action="{{ url('/finance/payment/' . $payment->id) }}">
                                            @csrf
                                            {{method_field('DELETE')}}
