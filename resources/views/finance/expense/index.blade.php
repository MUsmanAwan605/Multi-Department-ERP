        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    ...
                    <div class="ms-auto"><a href="/finance/expense/create" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add expense</a></div>
                </div>
                @if($expenses->count()>0)
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle">
                                    <div class="d-flex order-actions">
                                        <a href="{{ route('finance.expense.edit',$expense->id)}}" class=""><i class='bx bxs-edit'></i></a>
                                        <form method="post" action="{{ url('/finance/expense/' . $expense->id) }}">
                                            @csrf
                                            {{method_field('DELETE')}}
