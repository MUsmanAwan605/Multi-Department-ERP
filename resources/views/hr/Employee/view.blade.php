            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto"><a href="/hr/employee/add" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle">
                                                <div class="d-flex order-actions">
                                                    <a href="{{ route('hr.employee.edit', ['id' => $record->id]) }}"><i
                                                            class='bx bxs-edit'></i></a>

                                                    <form method="POST"
                                                        action="{{ route('hr.employee.destroy', ['id' => $record->id]) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            onclick="return confirm('Are you sure you want to delete?')"
                                                            style="outline:none;border:none;background:transparent">
                                                            <a href="{{ route('hr.employee.destroy', ['id' => $record->id]) }}"
