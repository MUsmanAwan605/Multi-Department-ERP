...
@section('humanresource')
		...
		<div class="page-wrapper">
			<div class="page-content">
                ...
                <form method="POST" action="{{ route('hr.employee.update', ['id' => $Employee->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        <div class="card">
								...
								<span class="text-danger text-uppercase ">{{ $errors->first('Father/HusbandName') }}</span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('MarriedStatus') is-invalid @enderror" name="MarriedStatus" aria-label="Default select example">
                                            ...
                                            <option value="Married" {{ old('MarriedStatus', $Employee->m_status) == 'Married' ? 'selected' : '' }}>Married</option>
                                            <option value="Single" {{ old('MarriedStatus', $Employee->m_status) == 'Single' ? 'selected' : '' }}>Single</option>
                                        </select>
                                ...
                                <div class="border border-3 p-4 rounded">
                                  {{-- <div class="row g-3"> --}}
                                   ...
                                   <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ old('e',$Employee->e_name) }}" class="form-control @error('EmployeeName') is-invalid @enderror" name="EmployeeName" id="bsValidation4" placeholder="Employee Name" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('Department') is-invalid @enderror" name="Department" id="Department" aria-label="Default select example">
                                        ...
                                        @foreach ($departments as $department)
                                            <option value="{{ $department->name }}" {{ old('Department',$Employee->department) == $department->name ? 'Selected' : NULL }}>
                                                {{ $department->name }}
                                            </option>
                                        @endforeach
                                    </select>
