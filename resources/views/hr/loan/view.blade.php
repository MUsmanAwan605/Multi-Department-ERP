                ...
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        <form method="GET" action="{{ route('search.loan') }}">
                            <div class="d-lg-flex">
                                <div class="col-8">
                                    <input type="search" name="search" class="form-control" placeholder="Search By CNIC">
                                </div>
                                <div class="ms-2">
                                ...
                                <tbody>
                                    @foreach ($records as $record)
                                        <tr>
                                            ...
                                            @else
                                                <td style="vertical-align: middle"><img width="70" height="70"
                                                        src="/uploads/Employee_Profile_img/{{ $record->photos }}"
                                                        alt=""></td>
                                            @endif
                                            <td style="vertical-align: middle"><a class="btn btn-primary"
                                                    href="{{ route('hr.loan.add', ['id' => $record->id]) }}">Add Loan</a>
                                            </td>
                                            ...
                                            <td style="vertical-align: middle">
                                                ...
                                                <a href="#" class="btn btn-success" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal{{ $record->id }}"> View Record</a>
                                                ...
                                                <div class="d-flex order-actions">
                                                    <a href="{{ route('hr.loan.edit', ['id' => $record->id]) }}"><i
                                                            class='bx bxs-edit'></i></a>

                                                    <form method="POST"
                                                        action="{{ route('hr.loan.destroy', ['id' => $record->id]) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
