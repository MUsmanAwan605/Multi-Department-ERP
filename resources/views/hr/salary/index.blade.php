            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        <form method="get" action="{{ route('search.salary') }}">
                            <div class="d-lg-flex">
                                <div class="col-8">
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle">{{ $salary->department }}</td>
                                                ...
                                                <td style="vertical-align: middle">
                                                    ...
                                                    View Record</a>
                                                    <!-- Modal -->
<div class="modal fade" id="exampleModal{{ $salary->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $salary->t_s_c_m_bef_deduction}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $salary->advan_deduction_amount}}</td></tr>
                                <tr>
...
<!-- Modal -->
                                            ...
                                            <td style="vertical-align: middle">
                                                <div class="d-flex order-actions">
                                                    <a href="/hr/salary/{{ $salary->id }}/edit"
                                                        class="btn btn-success">Edit</a>
                                                    <form method="POST" action="/hr/salary/{{ $salary->id }}">
                                                        @csrf
                                                        {{ method_field('DELETE') }}
                                                        <button type="submit"
                                                            onclick="return confirm('Are you sure you want to delete?')"
                                                            style="outline:none;border:none;background:transparent">
                                                            <a href="/hr/salary/{{ $salary->id }}/destroy"
