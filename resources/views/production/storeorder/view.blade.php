        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <form method="GET"  action="{{ route('store.storeorder.search') }}">
                        <div class="d-lg-flex">
                            <div class="col-8">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="{{ route('production.storeorder.edit',['id'=>$record->id]) }}" class=""><i class='bx bxs-edit'></i></a>
                                        <form method="POST" action="{{ route('production.storeorder.destroy',['id'=>$record->id]) }}">
                                            @csrf
                                            {{ method_field('DELETE') }}
                                            <button type="submit" onclick="return confirm('Are you sure you want to delete?')" style="outline:none;border:none;background:transparent">
                                                <a href="{{ route('production.storeorder.destroy',['id'=>$record->id]) }}" class="ms-3"><i class='bx bxs-trash'></i></a>
                                            </button>
                                        </form>
                                    </div>
                                </td>
