        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                  ...
                  <div class="ms-auto"><a href="{{route('product.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Product</a></div>
                  @if (session('success'))
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        ...
                                        <!-- <a href="/production/product/{{$product->id}}/destroy" class="ms-3"><i class='bx bxs-trash'></i></a> -->
                                    </div>
                                </td>
                            </tr>
                            @endforeach
