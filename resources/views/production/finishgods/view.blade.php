    ...
    @endif
        <div class="card">
            <div class="card-body">
                ...
                {{-- </div> --}}
                     <div class="ms-auto"><a href="{{route('finishgods.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Raw Rawmaterial</a></div>
                </div>
                @if($records->count()>0)
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle">
                                    <div class="d-flex order-actions">
                                        <a href="{{route('finishgods.edit', $record->id)}}" class=""><i class='bx bxs-edit'></i></a>
                                        <form method="post" action="{{route('finishgods.destroy', $record->id)}}">
												@csrf
												{{method_field('DELETE')}}
