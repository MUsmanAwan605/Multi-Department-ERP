				...
				<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
					 ...
					 <div class="card radius-10 border-start border-0 border-4 border-info">
						<div class="card-body">
							...
							<div class="d-flex align-items-center">
								<div>
									<a href="<?php echo e(route('admin.humanresources.index')); ?>" class="mb-0 text-secondary"><strong>Human Resources</strong></a>
				   ...
				   <div class="card radius-10 border-start border-0 border-4 border-info">
					  <div class="card-body">
						  ...
						  <div class="d-flex align-items-center">
							  <div>
								  <a href="<?php echo e(route('admin.finance.index')); ?>" class="mb-0 text-secondary"><strong>Finance</strong></a>
								  <h4 class="my-1 text-info">4805</h4>
								  <p class="mb-0 font-13">+2.5% from last week</p>
							  </div>
							  <div class="widgets-icons-2 rounded-circle bg-gradient-blues text-white ms-auto"><i class='bx bxs-cart'></i>
				   ...
				   <div class="col">
					<div class="card radius-10 border-start border-0 border-4 border-danger">
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
								   <a href="<?php echo e(route('admin.store.index')); ?>" class="mb-0 text-secondary"><strong>Store</strong></a>
				  ...
				  <div class="col">
					<div class="card radius-10 border-start border-0 border-4 border-success">
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
								   <a href="<?php echo e(route('admin.production.index')); ?>" class="mb-0 text-secondary"><strong>Production</strong></a>
				  ...
				  <div class="col">
					<div class="card radius-10 border-start border-0 border-4 border-warning">
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
							   <a href="<?php echo e(route('admin.qualityassurance.index')); ?>" class="mb-0 text-secondary"><strong>Quality Assurance</strong></a>
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlinefinalproject\resources\views/admin/index.blade.php ENDPATH**/ ?>