...
<body>
    ...
    <div class="wrapper">
        <!--sidebar wrapper -->
        <?php echo $__env->make('hr.body.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <!--end sidebar wrapper -->
        <!--start header -->
        <?php echo $__env->make('hr.body.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!--end header -->
        <!--start page wrapper -->
        <?php echo $__env->yieldContent('humanresource'); ?>
        <!--end page wrapper -->
        <!--start overlay-->
        ...
        <?php echo $__env->make('hr.body.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <!--end wrapper-->
    ...
    <!-- FOnt Awesome -->
    <script src="https://kit.fontawesome.com/2063c9566b.js" crossorigin="anonymous"></script>
    <!-- FOnt Awesome-->
    <!--plugins-->
...
<?php /**PATH C:\xampp\htdocs\onlinefinalproject\resources\views/hr/hr_dashboard.blade.php ENDPATH**/ ?>