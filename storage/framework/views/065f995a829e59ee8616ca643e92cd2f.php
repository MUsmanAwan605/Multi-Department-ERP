        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                    ...
                    <img src="<?php echo e(!empty($profileData->photo) ? url('uploads/admin_images/' . $profileData->photo) : url('/uploads/image-not-found.jpg')); ?>"
...
<!-- Admin Header Start -->
<?php /**PATH C:\xampp\htdocs\onlinefinalproject\resources\views/admin/body/header.blade.php ENDPATH**/ ?>