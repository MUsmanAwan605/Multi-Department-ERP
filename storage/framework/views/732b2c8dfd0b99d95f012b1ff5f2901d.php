                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle"><?php echo e($receipt->date); ?></td>
                                <td style="vertical-align: middle"><?php echo e($receipt->total); ?></td>

                                
                                <td style="vertical-align: middle">
                                    <div class="d-flex order-actions">
                                        <a href="<?php echo e(route('admin.finance.receipt.edit',$receipt->id)); ?>" class=""><i class='bx bxs-edit'></i></a>
                                        <form method="post" action="<?php echo e(url('admin/finance/receipt/' . $receipt->id)); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlinefinalproject\resources\views/admin/finance/receipt/index.blade.php ENDPATH**/ ?>