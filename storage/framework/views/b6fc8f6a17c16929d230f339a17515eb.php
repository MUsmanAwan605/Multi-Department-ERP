        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo e((!empty($profileData->photo)) ? url('uploads/hr_images/'.$profileData->photo) : url('/uploads/image-not-found.jpg')); ?>" class="user-img" alt="user avatar">
                    <div class="user-info">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('hr.profile')); ?>"><i class="bx bx-user fs-5"></i><span>Profile</span></a>
							<li><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('hr.change.password')); ?>"><i class="bx bx-cog fs-5"></i><span>Change Password</span></a>
							</li>
                    <li><a class="dropdown-item d-flex align-items-center" href="javascript:;"><i class="bx bx-home-circle fs-5"></i><span>Dashboard</span></a>
                    </li>
                            <li><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('hr.logout')); ?>"><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
							</li>
                        </form>
                    </div>
                    </li>
...
<?php /**PATH C:\xampp\htdocs\onlinefinalproject\resources\views/hr/body/header.blade.php ENDPATH**/ ?>